...
Historical Vignettes work. First drafted with several entries leaning on post-war facts (Belgrano's "Boneyard
Times" faction, Zukelli's and Denison's destruction, Janbogo being left standing to witness a strike, Troll's
...
**Revised understanding of Mars, 2026-08-05:** the earlier claim that Mars/Phoenix couldn't fit any pre-war
city (since nothing had literally died yet) turned out to be too narrow a reading. The developer applied it
to three cities using a broader, still pre-war-appropriate sense of "revival" — not death-and-rebirth from
war damage, but **drifting away from an original purpose or condition, then returning to it**: Esperanza
(centuries of drift, back to being family-oriented), Casey (centuries of drift, back to being culture-
