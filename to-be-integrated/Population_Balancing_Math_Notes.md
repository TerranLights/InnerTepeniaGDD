...
- **139,376 humans** — the portion carried over from earlier population figures
...
from that portion, and 34 nations from the Palmer City portion — riding along with
...
30,000 humans moved from Sayowa's own China-heavy composition to Vostok's existing (previously-carried
...
expansion, and Kunlun/Dome Fuji/Concordia's new populations), even
...
- **Esperanza, Concordia, Zukelli, Janbogo, and Cape Adare** — their own shares of the carried-over
