...
- **Nations present, by tier:** Primary — USA. Significant — Germany, UK, Spain, Canada, Mexico,
  Brazil. Notable — Argentina (founding wave), Chile (founding wave), Uruguay. Exact per-nation share %
  in `Specs/Marambio.md` and `Official_Population_Census.md`.
- **Geography:** Seymour Island (Isla Marambio), eastern Antarctic Peninsula coast, Weddell Sea — south
  of Esperanza but still north of the Antarctic Circle. Geologically extraordinary: Eocene-era fossil
  beds (~34-56 million years old).
- **Geological composition:** Sedimentary rock island — a genuine geological archive of Antarctica's
  pre-ice, forested past; runway infrastructure made it the subnet's eastern aviation hub.
...
matches should favor real-world sedimentary/fossil-rich terrain, ideally with an aviation connection.

- **USA (Primary):** St. Paul Island, Pribilofs, Bering Sea — a real sedimentary/volcanic island with
  its own small airport; a modest structural match.
- **Germany (Significant):** No strong domestic match — flagged as weak.
- **UK (Significant):** The Jurassic Coast, Dorset — a genuine fossil-rich sedimentary coastline, an
  excellent thematic match for Marambio's own fossil-bed identity, even without the island/aviation
  angle.
- **Spain (Significant):** No strong domestic match — flagged as weak.
- **Canada (Significant):** Dinosaur Provincial Park, Alberta — a real sedimentary fossil-rich
  "geological archive" landscape, a strong thematic match despite being inland rather than island
  terrain.
- **Mexico (Significant):** No domestic match — flagged as weak.
