...
- **Nations present, by tier:** Primary — USA. Significant — Germany, France, UK, Brazil. Notable —
  Argentina, South Africa (founding wave), Chile, Uruguay. Exact per-nation share % in `Specs/Signy.md`
  and `Official_Population_Census.md`.
- **Geography:** Signy Island, South Orkney Islands, Scotia Sea — ~500km east of the Peninsula tip,
  ~1,700km south of the Falklands; geographically isolated, no land connection to anything. Technically
  sits north of the informal 60°S "Antarctica" boundary.
- **Geological composition:** Sub-Antarctic island terrain — biologically the richest and most
  productive location in Tepenia (Scotia Sea convergence of Atlantic/Pacific/Southern Ocean waters);
  weakest Arcanet link of any intra-subnet connection in the country.
...
richest location in Tepenia — matches should favor genuinely isolated, biologically rich real-world
islands, not just cold maritime terrain generally.

- **USA (Primary):** The Pribilof Islands (St. Paul/St. George), Bering Sea — genuinely isolated,
  biologically rich (major fur seal and seabird colonies), a strong thematic match.
- **Germany (Significant):** No domestic match — flagged as weak.
- **France (Significant):** The Kerguelen Islands — isolated, biologically rich French Southern
  Territory, a strong thematic match, though an institutional rather than settled population.
- **UK (Significant):** South Georgia — genuinely isolated and among the most biologically productive
  UK sub-Antarctic islands; the single best match available for this city.
- **Brazil (Significant):** No domestic match — flagged as weakest.

---

## City-Type Parallels (Phase 1b-ii — functional/civic identity, not geography)

**City type:** scientific research (marine biology/ecology) + fishing/maritime resources of the Scotia
Sea.
...
- **UK (Significant):** Plymouth — a real UK marine-biology research city (home to the Marine
  Biological Association), a strong match.
- **Brazil (Significant):** No standout domestic marine-biology-research-town match — flagged as weak.
