...
- **Geological composition:** Small sheltered-harbor island — the oldest continuously-relevant founding
  history of any Tepenian city (predates even the exploration/research era).
...
- **USA (Primary):** Mystic Seaport, Connecticut — a real American maritime-heritage/tourism town
  built around a preserved historical identity, a strong structural match.
