...
| **Cut Losses** *(added 2026-07-28 — surfaced while assigning companion romance forbidden-trait gates for Favi della Torre; see `Core-Mechanics/Companion_System.md`'s "Forbidden Traits" section)* | Disengaging from combat costs 50% less AP — a genuine self-preservation reflex | The active companion's Bond-building progress (`Core-Mechanics/Fragmentation_Matrix.md`) is permanently halved | A character whose defining instinct is saving themselves first, at real cost to building trust with anyone traveling alongside them — the opposite of a protector archetype |
