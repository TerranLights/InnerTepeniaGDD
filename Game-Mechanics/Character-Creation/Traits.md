...
| **Narrative Ghost** *(escalated 2026-07-28 after becoming the forbidden trait for 8 companions — Naizelle, Villena, Ji-Eun, Trisha, Seica, Flora, Vosora, Ayako — its real cost had grown well past the original bonus's weight, the same issue Cut Losses hit at 5. Two additions layered on, matching the name's own "leaves no trace" identity)* | +20% Deception<br>+15% Narrative<br>Unlocks an extra dialogue option to probe any NPC for rumors/information<br>+1 Nerve<br>**Once per reputation-affecting act, retroactively erase that act's reputation consequence entirely — as though it was never traced back to the player**<br>**Negative Reputation gains permanently reduced by 25% across the board, stacking with the once-per-act erasure above** | -1 Humanity ("harder to build genuine trust") | Information brokers, manipulators — someone who leaves no trace in the story others tell, both in the rare complete erasure and the everyday background protection |
...
| **Cut Losses** *(added 2026-07-28 — surfaced while assigning companion romance forbidden-trait gates for Favi della Torre; see `Core-Mechanics/Companion_System.md`'s "Forbidden Traits" section. **Escalated 2026-07-28** after becoming the forbidden trait for 5 companions (Favi, Villena, Michelle, Trisha, Seica) — its real cost had grown well past the original bonus's weight. First revision (50% less AP to flee, +survive-at-1-HP-once-per-combat) was itself corrected the same day: a mere AP discount on fleeing is pointless since AP fully replenishes once combat ends anyway, and 1 HP survival is barely a reprieve)* | **Zero AP cost to flee from combat** (not just discounted — fleeing costs nothing at all)<br>**When reduced to 0 HP, instead of going down, automatically disengage from combat and survive with 50% HP instead — once per combat** | The active companion's Bond-building progress (`Core-Mechanics/Fragmentation_Matrix.md`) is permanently halved | A character whose defining instinct is saving themselves first, at real cost to building trust with anyone traveling alongside them — the opposite of a protector archetype. A genuine anti-death safety net, proportional to how disqualifying this trait has become across the romance roster |
| **Greener Pastures** *(added 2026-07-28, flagged for future renaming — surfaced while considering Michelle Stanton's forbidden traits, but ultimately NOT used for her; see `Forbidden_Trait_Design_Method.md`'s design history for why. Originally conceived with a "first time trading with this merchant/district" conditional trigger, but every conditional version tested — per-district novelty (hard 13-use ceiling), per-merchant novelty (still exhaustible, just at a higher ceiling), and a 7-day recency cooldown (freely resettable via any Wait mechanic, making the "cost" illusory) — broke under scrutiny. Settled on a flat, unconditional bonus instead, the same shape Cut Losses already uses, with no exploit surface at all)* | +10% Barter effectiveness, always active, no trigger condition | Reputation with any single district can never rise above "Liked" — the top tier, Idolized, is permanently locked out everywhere | A character who is always good at finding an advantageous deal, wherever they are, but never stays anywhere long enough to be truly beloved in one place |
| **Fists First** *(added 2026-07-28 — surfaced while considering Trisha Miller's forbidden traits, but ultimately NOT used for her; her own personal philosophy is "words first, fists only when words fail," so a violence-first personality reads as distasteful to her rather than an outright dealbreaker — see `Forbidden_Trait_Design_Method.md`)* | Attacks made as the opening action of combat deal +15% damage | De-escalation/conflict-avoidance dialogue options are never available in any conversation — a real structural loss, not a skill percentage penalty | A character who skips straight to violence with no patience for talking anything through — doesn't hesitate to escalate immediately |
| **Demagogue** *(added 2026-07-28, renamed from working title "Crowd Pleaser" — surfaced while considering, and confirmed applied to, Trisha Miller's forbidden traits; see `Forbidden_Trait_Design_Method.md`. **Production dependency flagged 2026-07-28:** this trait's bonus is only meaningful if the game actually contains a sufficient number of interactions where the player addresses crowds/groups of people, not just one-on-one dialogue — not yet confirmed to exist in adequate quantity; revisit once dialogue/quest content design reaches that question)* | +20% Speech/Narrative effectiveness specifically when addressing groups or public gatherings | Every NPC's first impression of this character defaults to skeptical/wary, regardless of stats — a universal handicap overcome only individually, not a stat penalty | A performer of conviction rather than a holder of it — someone who tells crowds what plays well rather than what's true, in direct contrast to a character whose credibility depends on their public voice being genuinely real |
| **[NAME TBD — "Broad Strokes" working title]** *(flagged 2026-07-28, deliberately held/unfinished — surfaced while considering Majyao Bisyugota's forbidden traits, but set aside rather than applied to her or finalized. See `Forbidden_Trait_Design_Method.md`. **The bonus is still undecided** — three candidates floated, none chosen: (1) +15% Speech (a confident, direct communicator who doesn't hedge or dwell on nuance), (2) +15% Survival/Outdoorsman ("broad strokes" applied to navigation — reads the general lay of the land without needing every landmark), (3) a flat combat-initiative bonus (acts first when combat begins). An initial "+15% Barter on fast, decisive trades" version was rejected — the game has no timer/speed mechanic for trades to hook into, and inventing one just for this trait's flavor would be an unnecessary new system, the same lesson as Greener Pastures' own balance history)* | **TBD — pick one of the three candidates above (or propose another) before finalizing** | Never notices small environmental details, hidden objects, or subtle discrepancies, regardless of Investigation stat — a hard override, not a percentage penalty, the same shape as Demagogue's universal first-impression skepticism | A character who thinks and acts in broad strokes, decisive and big-picture, at the cost of ever noticing the small specific thing a detail-oriented person would catch |
| **One-Way Exchange** *(flagged 2026-07-28 for future review, not finalized — surfaced while considering Vosora Lashár Tanslock's forbidden traits, but NOT applied to her sheet for now. See `Forbidden_Trait_Design_Method.md`. Went through two corrections the same day: the bonus was originally a percentage success-chance improver, which doesn't exist as a mechanic in this game's flat-threshold system (`Skills.md`'s "Flat Thresholds, No Dice Rolls" law); corrected to a flat skill-point bonus instead, then corrected again after an initial version used MACHINE-stat-scale numbers (+2, meaningful on a 1-10 stat) on what should be a skill-scale bonus (1-100), where +2 is negligible. **Real remaining concern, not yet resolved:** the bonus requires tracking which specific pieces of information/clues were NPC-given versus self-discovered, and tagging specific skill checks throughout the game as "informed checks" this trait applies to — a genuine per-quest content/tagging cost, not a one-time system, similar in shape to Demagogue's crowd-content dependency)* | +20 to effective Investigation, specifically for skill checks that use information or a clue gained from another character | NPCs who share a piece of information with this character never volunteer a second one — a hard, permanent cutoff, not a percentage penalty | A character who only ever takes knowledge from others without ever reciprocating — an intellectual free-rider, distinct from Narrative Ghost's deception since this isn't about lying, just never giving anything back |
| **No Mercy** *(added 2026-07-28 — surfaced and developed while considering Ayako Hayashi's forbidden traits; see `Forbidden_Trait_Design_Method.md`. Scope note: an initial penalty version — "any interaction with a human, whenever a violent option exists, auto-fires it" — was scaled back after being flagged as the largest production dependency any trait in this pass had needed, requiring every human-NPC dialogue scene in the game to be checked. Narrowed to already-tense/hostile scenes specifically, a much smaller and more tractable content category)* | **+20% critical hit chance and +50% critical damage against robots<br>+40% critical hit chance and double critical damage against humans** — a deliberate, flavorful asymmetry: this character is mechanically far more dangerous, and far less restrained, specifically toward humans than toward robots | In already-tense/hostile scenes involving a human, whenever a violent option exists, it automatically becomes the next step — no player choice at that point, the violent branch fires on its own | A character constitutionally incapable of mercy once a human confrontation turns adversarial — someone who has no capacity to hold back, spare, or accept a human's surrender |
