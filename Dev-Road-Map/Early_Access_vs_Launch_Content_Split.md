...
### Tentative Early Access Companions — shortlist, established 2026-07-10; one now confirmed
...
- **IT-068 "Flora"** — Capricorn (Beat 2). **CONFIRMED for Early Access, 2026-07-10.** Flora is planned as likely the very first recruitable companion the player will meet at all, assuming the player follows Calethina's own early lead — that structural position (first companion, on the critical path from the opening beat) is reason enough to lock her in on its own.
