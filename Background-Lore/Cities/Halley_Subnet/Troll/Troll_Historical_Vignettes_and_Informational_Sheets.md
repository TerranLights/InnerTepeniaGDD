# Troll — Historical Vignettes & Informational Sheets
...
Troll's foundation engineering on Jutulsessen's exposed rocky outcrops (attribute #9) predates the airfield's
own political fracture entirely — the terrain and the climate engineering built against it exist, per
Finding F, on a track completely independent of everything else currently defining the city (attribute #10's
own coldest, most continental climate profile in the subnet).

The nunatak's own exposed rock, more dramatic and more thoroughly interior than Sanay's comparatively
moderate siting, presented the founding-era construction crews with a genuinely different engineering problem
than any other Halley subnet city faced — anchoring structures directly into exposed stone rather than
managing ice-shelf instability or ordinary snow accumulation. The earliest foundation work, per surviving
construction-era notes, took considerably longer than initially planned specifically because the rock itself
proved more variable in composition than early surveys suggested — sections that read as solid on initial
