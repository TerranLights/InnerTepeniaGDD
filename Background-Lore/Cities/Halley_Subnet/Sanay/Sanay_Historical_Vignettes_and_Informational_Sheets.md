# Sanay — Historical Vignettes & Informational Sheets
...
The Halley Subnet Arcanet Relay Nexus (attributes #6–7) sits physically in Sanay, on bedrock stable enough to
guarantee the kind of permanence no ice-founded city could offer critical infrastructure — but the labor that
actually built it belonged to Halley, whose residents did the hands-on construction work, and the finished
facility carries Halley's name rather than Sanay's (Finding C).

The construction itself, per surviving records, involved sustained crews from Halley traveling to and
working in Sanay for the duration of the build — a genuine cross-city labor arrangement, not merely Halley's
own engineers directing local Sanay workers. Sanay's own contribution was the site itself and whatever local
support the build required; the actual physical work of raising the relay housing and running the bedrock-
integrated cabling was Halley's own. The everyday name that stuck afterward — "the Halley subnet relay," not
