# Davis — Building With the Land, Not Against It
...
Most Tepenian cities engineer their architecture primarily to defend against wind — a standardized,
proven approach that early Davis planners have every reason to simply adopt wholesale, the way most
exile settlements do.
...
**Design notes — what kind of conflict this needs:** a confrontation between a planner advocating for
proven, standardized wind-first construction — the safe, tested approach used successfully across
Tepenia — and a planner arguing Davis's terrain deserves a more responsive, site-specific approach even
at the cost of more custom engineering and less standardization. Character A's caution is reasonable:
...
A hybrid approach wins the argument rather than either side's position outright — core wind-safety
standards stay non-negotiable, but siting decisions within those standards deliberately favor lake
access and fjord-sheltered locations wherever the terrain allows it, letting the landscape's natural
features do real protective and functional work rather than engineering around them uniformly
everywhere.
...
Because siting decisions now vary by location rather than following one uniform citywide template,
Davis's construction sector develops real, ongoing expertise in site-specific engineering — evaluating
each new building site individually against the terrain's own features — rather than applying a single
standardized wind-defense template the way most other Tepenian cities' construction sectors do.
