...
- [ ] **Amundsen Tower — determine actual dimensions**
  ...
  **Full logistics worked (2026-07-02):** 300 bearing stations at 500m spacing (~30,000t total); 5 waystations (Base, ~15km, ~50km, ~100km/Kármán line, 150km terminus); base facility layout (accelerator + power generation + pellet return loop unified in the ~2.7km foundation shaft, ~1-2km² surface complex). **Throughput finding:** moving the full 9.5M orbital population via the Tower over the ~65-year window between completion and the Long Night War only requires ~17 people/hour average — the tower's existing 150km design comfortably supports this without needing to be sized any larger. All detail in `Theoretical-Calculations/Amundsen_Tower_Space_Fountain_Design.md`.
