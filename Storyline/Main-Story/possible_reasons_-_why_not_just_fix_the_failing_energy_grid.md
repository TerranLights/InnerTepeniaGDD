# Why don't they just fix the grid?
### One thing that can ruin the immersion is that players may ask, "Why not just fix the failing energy grid?"
...
* The ground itself is unstable — permafrost heave, ice quakes, and constant micro-shifts constantly re-damage repaired sections.
...
### How This Ties Into Gameplay
* Act 1: You’re not fixing the whole grid — you’re performing emergency triage on one failing sector while Calethina warns you that any real solution will take years and massive trade-offs.
    * Throughout the game: Every “repair” quest you undertake creates new problems elsewhere (classic CRPG tension).
...
* Because the destroyed Amundsen Tower once drew massive planetary-scale energy, the remaining Antarctic grid has developed strange harmonic instabilities. Large-scale repairs create dangerous resonance feedback loops that can cause synchronized blackouts across multiple districts simultaneously — worse than the problem they’re trying to solve.

##### 12. Institutional Memory Loss & Skill Decay
* The most experienced grid engineers either evacuated off-world or died during the Midnight War. The current generation learned through fragmented apprenticeships and Calethina’s incomplete archives. Every major repair attempt in the last 30 years has caused new, unexpected failures because critical knowledge is simply gone.
...
* Investigate the Amundsen Resonance Effect
