...
**Main storyline:** TBD — nature of Byrd's struggle also TBD
**Key lore assets:**
...
**Main storyline:** TBD
**Key lore assets:**
- Indian Ocean coast cities (Mawson subnet proper): Mawson, Sayowa, Dome Fuji *(corrected 2026-07-05 — Soyuz, Bharati, Zhongshan, and Davis all moved to the Mirny subnet/DLC 7; the Larsemann Hills cluster they share with Zhongshan sits far closer to Davis than to Mawson Station. See `TODO.md` and DLC 7's entry, below, for the full reasoning.)*
...
- **The Larsemann Hills / Prydz Bay cluster — added 2026-07-05:** Zhongshan, Davis, Soyuz, and the Japanese city (cf. Bharati) are all Mirny subnet territory. Zhongshan and Davis were already established here; Soyuz and Bharati joined 2026-07-05 (moved from Mawson subnet — real-world geography places the Larsemann Hills far closer to Davis than to Mawson Station; see `TODO.md`). Zhongshan is the only Tepenian city where the founding operator nation (China) is also the long-run demographic Primary; Davis holds the "competence is humility" angle of the Competence Without Commentary faction; Soyuz is named for the spacecraft program, chosen by its founders as a symbol of ambition; the Bharati-site city's founding was institutionally engineered by pre-exile Upper Earth diplomacy (the Jeju-do court), the only Tepenian city founded this way. Soyuz and Zhongshan sit at nearly identical real-world coordinates — a few hundred meters apart — making them one of Tepenia's densest multi-city clusters, comparable to King George Island in the Palmer subnet. Hwy 4 physically connects this cluster to Mawson despite the subnet boundary (see DLC 4's entry, above).
