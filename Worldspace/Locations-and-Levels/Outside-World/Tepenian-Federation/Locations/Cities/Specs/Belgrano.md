...
**Settled:** Post-Falkland Treaty, on Belgrano II Base infrastructure. The Argentine Air Force operated here from 1979 until the 2083 nuclear war ended Upper Earth's national Antarctic programs — after which the base sat dormant for nearly five centuries before the 2564 exiles arrived. *(Corrected 2026-07-24, GPS-purposes-only pass: the Air Force's own command structure and personnel could not have persisted across that gap — there is no continuous military chain of command running from 1979 into the exile settlement. See the Character & Culture note below for the corrected framing.)* The runway itself — physical infrastructure, genuinely inherited — gave Belgrano its Halley subnet role as the primary aviation hub, paralleling Marambio's role in the Palmer subnet.
...
Belgrano had the operational character of an aviation hub — transient, functional, purposeful. Its founders arrived at an inert, long-abandoned military airbase, not a functioning one *(corrected 2026-07-24, GPS-purposes-only pass — no Air Force command structure survived to extend authority over them)*, and the discipline required to bring a runway back into operation and keep it running in one of Tepenia's harshest positions shaped their own institutional culture from scratch. The deep Weddell Sea position gave it a frontier quality relative to the more accessible Queen Maud Land coastal cities.
