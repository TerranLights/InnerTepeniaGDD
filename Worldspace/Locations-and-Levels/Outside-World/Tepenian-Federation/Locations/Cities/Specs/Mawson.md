...
|------|--------|---------|------------------|------------------|-------------------|-------------------|
| Primary | China | 17.02% | 125,447 | 120,805 | 89,383 | 72,735 |
| Significant | UK | 8.99% | 66,282 | 63,829 | 47,227 | 38,431 |
| Significant | Australia | 8.29% | 61,129 | 58,867 | 43,555 | 35,443 |
| Significant | Indonesia | 7.89% | 58,180 | 56,027 | 41,454 | 33,733 |
| Significant | Japan | 7.48% | 55,106 | 53,067 | 39,264 | 31,951 |
| Significant | France | 5.29% | 38,980 | 37,537 | 27,774 | 22,601 |
| Significant | South Korea | 4.87% | 35,906 | 34,577 | 25,583 | 20,818 |
| Notable | Estonia | 3.17% | 23,379 | 22,514 | 16,658 | 13,555 |
| Notable | South Africa | 3.09% | 22,809 | 21,965 | 16,252 | 13,225 |
| Notable | Norway | 3.05% | 22,445 | 21,615 | 15,993 | 13,014 |
| Notable | Vietnam | 2.99% | 22,000 | 21,186 | 15,675 | 12,756 |
| Notable | Thailand | 2.97% | 21,892 | 21,081 | 15,598 | 12,693 |
| Notable | Belarus | 2.93% | 21,616 | 20,816 | 15,401 | 12,533 |
| Notable | Netherlands | 2.92% | 21,495 | 20,700 | 15,316 | 12,463 |
| Notable | Slovenia | 2.71% | 19,959 | 19,220 | 14,221 | 11,572 |
| Notable | Bulgaria | 2.68% | 19,763 | 19,031 | 14,081 | 11,458 |
| Significant | Germany | 1.86% | 13,717 | 13,210 | 9,774 | 7,953 |
| Notable | Czech Republic | 1.57% | 11,599 | 11,170 | 8,265 | 6,725 |
| Notable | Slovakia | 1.55% | 11,403 | 10,981 | 8,125 | 6,611 |
| Notable | Lithuania | 1.34% | 9,866 | 9,501 | 7,030 | 5,721 |
| Notable | Hungary | 1.32% | 9,746 | 9,386 | 6,944 | 5,651 |
| Notable | Romania | 1.28% | 9,470 | 9,120 | 6,748 | 5,491 |
| Notable | Poland | 1.27% | 9,362 | 9,016 | 6,671 | 5,428 |
| Notable | Croatia | 1.21% | 8,916 | 8,586 | 6,353 | 5,170 |
| Notable | Latvia | 1.16% | 8,553 | 8,236 | 6,094 | 4,959 |
| Notable | Ukraine | 1.08% | 7,983 | 7,688 | 5,688 | 4,629 |
...
St. Douglas (Mawson) is the patron Saint of this city and subnet. His connection here is complete: the city, the subnet, the territory are all named for him or his legacy.

### Annual Climate

**Climate data source:** Australian Antarctic Division (AAD) — BAS READER (1991–2020 WMO standard normal, 30 years; full record 1954–2026)  _https://legacy.bas.ac.uk/met/READER/_
...
Mawson had the character of a city that had been here the longest of anyone in its subnet and knew it. **Corrected 2026-07-24, GPS-purposes-only pass:** the "deep roots and accumulated knowledge" this identity rests on trace to Tepenia's own 2564 founding, not the real station's 1954 origin — that gap is centuries wide, and the original operators left nothing behind but the physical shell. Since 2564, unbroken operation of an aging, always-occupied facility through everything the continent threw at it left the exile community with a working culture that was practical, endurance-focused, and institutionally competent — earned through the sheer duration of *their own* tenure, not inherited from any single founding population, and certainly not from the station's own pre-exile history.
...
**Unmarked background lore, 2026-07-16:** Mawson's own hospitality economy is the original commissioning point for what eventually became Calethina, Concordia's own activation-lab hologram. She was requested here as a "welcoming host" hologram for arriving honeymoon guests and general visitors, which is why her founding design requirement was breadth — a genuine working knowledge of the whole country, not just Mawson's own local specifics, so she could hold a real conversation with visitors from anywhere. What actually happened to her after leaving Mawson (spec design at Neumayer, engineering at Kunlun, construction at Byrd, and a wartime diversion far from her original purpose) is recorded in `Worldspace/Characters/Dolls/Still-Present_-_In-Game/unsure and_or special cases/Calethina/Personal_Background/Founding_Construction_Chain_Play-by-Play.md` — discoverable-only lore, no in-game quest markers, per the same treatment as the Cradle network.
...
Mawson is the Mawson subnet hub — its Arcanet connection to the rest of Tepenia was, before the Split Brain, the primary one. Post-Split Brain, the Mawson subnet's history is DLC 4 territory. Concordia knows Mawson's name; it is the face of the subnet.
