...
**Settled:** Post-Falkland Treaty, on Syowa Station infrastructure. JARE operated at this location from 1957 until the 2083 nuclear war ended Upper Earth's national Antarctic programs — after which the station sat dormant for centuries before the 2564 exiles arrived. *(Corrected 2026-07-24, GPS-purposes-only pass: JARE's own scientific programs, and any institutional memory of them, could not have survived that gap.)* The exile community inherited the extensive physical infrastructure JARE left behind, and built their own research culture on it independently.
