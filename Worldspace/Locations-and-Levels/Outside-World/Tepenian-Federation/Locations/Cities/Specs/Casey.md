...
|------|--------|---------|------------------|------------------|-------------------|-------------------|
| Primary | USA | 21.96% | 167,347 | 161,166 | 132,902 | 95,963 |
| Primary | China | 19.06% | 145,243 | 139,878 | 115,348 | 83,287 |
| Significant | South Korea | 10.46% | 79,721 | 76,777 | 63,312 | 45,715 |
| Significant | France | 10.05% | 76,605 | 73,775 | 60,837 | 43,928 |
| Significant | Australia | 9.26% | 70,528 | 67,923 | 56,011 | 40,443 |
| Significant | Russia | 6.13% | 46,693 | 44,969 | 37,083 | 26,776 |
| Significant | Japan | 5.33% | 40,616 | 39,116 | 32,256 | 23,291 |
| Significant | Indonesia | 4.92% | 37,500 | 36,115 | 29,781 | 21,504 |
| Notable | New Zealand | 3.36% | 25,577 | 24,633 | 20,313 | 14,667 |
| Notable | Philippines | 3.35% | 25,544 | 24,600 | 20,286 | 14,648 |
| Notable | Vietnam | 3.21% | 24,450 | 23,547 | 19,418 | 14,021 |
| Notable | Malaysia | 1.78% | 13,530 | 13,030 | 10,745 | 7,759 |
| Notable | Thailand | 1.13% | 8,583 | 8,266 | 6,816 | 4,922 |
...
The coast here is accessible by sea during the navigable season, with the Budd Coast offering reasonably sheltered anchorage by Antarctic standards. This made Casey a viable destination for incoming ships during the exile period.

A few kilometers from the city site stand the ruins of Wilkes Station — an American research station predating even the exile era, abandoned decades before the Federation was founded. Wilkes is a genuine historical artifact: not a Tepenian city, not an exile settlement, but a remnant of the pre-exile world that existed at this location when the robots arrived. It is the only pre-exile non-Tepenian ruin in the vicinity of Casey and was a local curiosity throughout Casey's existence.

Inland from the coast, the Budd Coast katabatic system funnels cold air from the East Antarctic plateau — not as severe as the conditions at Janbogo or on the plateau itself, but strong enough to make the junction between coast and interior feel physically distinct. Travelers who arrived in Casey from the sea and then turned inland on Hwy 110 toward Concordia would have felt that transition — from maritime Antarctic cold to the drier, colder, higher plateau air — over the course of the road.

### Annual Climate

**Climate data source:** Australian Antarctic Division (AAD) — BAS READER (1991–2020 WMO standard normal, 30 years; full record 1959–2026)  _https://legacy.bas.ac.uk/met/READER/_

*(Research note: verify all figures against Casey Station climate records — the Australian Antarctic Division (AAD) / Australian Bureau of Meteorology is the operating authority.)*

**Climate type:** Coastal polar — milder than the interior plateau; moderate maritime influence; stronger katabatic component than Palmer
**Mean annual temperature:** -9.3°C  _(READER station: Casey; 1991–2020 WMO standard normal)_
...
- **Katabatic winds:** less extreme than Janbogo but a persistent presence; the cold interior air from the plateau funnels toward the coast and creates strong, dry wind events that feel distinctly different from the maritime storm systems arriving off the sea
- **Sea ice:** forms seasonally; the Budd Coast is accessible to shipping during the navigable season (roughly November–March) but ice-locked in winter; this directly determined Casey's supply windows
- **Rapid condition shifts:** the combination of interior katabatics and maritime storm tracks means Casey's weather could change quickly; a mild coast-facing day could be followed immediately by a katabatic event off the plateau
- **The Antarctic Circle effect:** at Casey's latitude, the winter solstice produces approximately 5 hours of very low-angle daylight; the sun barely clears the horizon, casting long shadows across the ice for a few hours before setting again; this "liminal" lighting quality — never quite dark, never quite bright in winter — is atmospherically distinct from both the full polar night cities further south and the longer-day maritime cities further north

#### Gameplay Notes

- **The threshold city:** Casey's position at the Antarctic Circle — the literal geographic edge of the polar zone — gives it a specific atmospheric quality; it is the last place that feels "connected" to the outside before the deep interior; travelers arriving from or departing to Concordia would have experienced a qualitative shift at Casey
- **No polar night, barely:** the short winter days (5–6 hours) create a dim, liminal winter light rather than full darkness; ruins exploration in a Casey DLC or side-content setting would use low-angle winter light as an atmospheric tool rather than full polar night
...
Casey occupied a particular position in Tepenian culture: the threshold city. To travel from the coast toward Concordia — from the open sea world of the Mirny subnet into the deep interior — you came through Casey. To leave Concordia for the coast, Casey was your first city after the long inland drive. Every refugee moving inland during the Long Night War, every supply convoy, every traveler in either direction on Hwy 110, passed through Casey.

This transit character shaped Casey's culture into something pragmatic and open. It was not a city that celebrated itself the way Palmer City did; it was a city that served a function, and it was good at that function. The junction between Hwy 2 and Hwy 110 — the last stop before the deep interior or the first stop after it — gave Casey a natural role as a layover, a resupply point, a place where information exchanged hands because everyone coming from somewhere else stopped here.
...
Built on transit and junction economics. Casey's position at the intersection of Hwy 110 and Hwy 2 meant it naturally became a hub for goods moving between the Mirny subnet coastal cities and the interior. Resupply, rest, maintenance, information exchange — the economy of a transit city.

The Australian founding infrastructure included research and scientific capacity that may have translated into applied technical industries (TBD — Australian Antarctic Division operated specialized equipment at the real Casey Station). Full economic detail TBD.
