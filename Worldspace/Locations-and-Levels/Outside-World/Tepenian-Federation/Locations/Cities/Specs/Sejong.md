...
*(De-stacked 2026-07-05, recalculated 2026-07-13 after China's removal — raw tier-share percentages naturally produced blocks of nations with identical figures; applied a randomization method to break these into distinct, non-repeating values while preserving each tier's total and ordering. See `TODO.md` for the full method.)*
...
The Janbogo connection, corrected 2026-07-13: Sejong and Janbogo were both founded by Korean exiles and named after Korean historical figures, but Sejong's own Korean population diluted over roughly two and a half centuries of King George Island's extreme multinational immigration down to just 5.79%, the smallest of its eight Significant-tier nations, well behind the USA's sole-Primary 21.65% and France's 11.62%. Tepenia's living Korean population centers today are Janbogo and Sinheung (Mirny subnet, singularly Korean-founded via the Jeju-do partition, still Korean-Primary at 34.62%) — Sejong shares a founding-era naming heritage with Janbogo, not an ongoing demographic one. This is the same pattern already resolved at Sayowa (Japan-founded, diluted, superseded as "the" Japanese city by Shirayuki): a shared founding-era naming choice surviving after the living identity moved elsewhere.

### Annual Climate

**Climate data source:** Korea Polar Research Institute (KOPRI) — BAS READER (1991–2020 WMO standard normal, 30 years; full record 1988–2026)  _https://legacy.bas.ac.uk/met/READER/_
...
- **Mild climate:** the most forgiving environmental conditions of any Tepenian DLC location; the hazards here are structural and narrative, not environmental

---

## Founding

**Settled:** Post-Falkland Treaty, with the unusual founding condition of multiple exile communities already present on the island. The national groups that had operated research stations here — Korean, Argentine, Brazilian, Chilean, Sinian, Polish, Russian, Czech, Uruguayan — each had a pre-existing foothold. Sejong was the Korean settlement; it was surrounded by its neighbors from day one.

**Founding population:** South Korean exiles. The city shares the island with communities that eventually became separate settlements or merged into Sejong's orbit depending on their size — details TBD.

The name honors King Sejong the Great (1397–1450), who commissioned the creation of Hangul and transformed Korean cultural and intellectual life. An exile community honoring the king who gave their ancestors the means to record themselves.
...
## Notable Locations
- **The multinational district boundary zones** — wherever Sejong's territory met its neighbors; in ruins, these boundary areas are architecturally transitional
- **King George Island harbor** — the main maritime entry point; well-used given the island's accessibility
...
## Legacy
Sejong's legacy is the coexistence experiment — the proof that a dozen national communities could share a small island and make something out of it. Whether that experiment was a success or a source of conflict is a lore question for DLC 3.
