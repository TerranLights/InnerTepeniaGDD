...
**Maritime access:** **Española Cove**, in South Bay on the Hurd Peninsula — *used for the transfer of people and cargo*, with sheltered **Johnsons Dock** adjacent and ice-free shore at **Ojeda Beach**. ⛔ **`Access type: NONE` above means NO ROAD.** *Air access is via Machu Picchu Airport (`Airports.md`, "Served, Not Host").* Full entry: `/home/kuroskalacs/Documents/Doll-Fi/media/games/Inner Tepenia/InnerTepeniaGDD/Worldspace/Locations-and-Levels/Outside-World/Tepenian-Federation/Locations/Infrastructure/Ports.md` §5.6a.
...
The South Shetland Islands were one of the first parts of Antarctica reached by sealers and whalers in the early 19th century — the islands' sealing history predates even the formal discovery of the continental interior. Juan Carlos inherits a site with a layered pre-exile history: sealing-era activity, scientific research, exile settlement.
