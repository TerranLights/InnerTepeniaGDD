...
Belgrano's crews built Tepenia's first native, homemade tracked overland vehicles for the crossing — officially unnamed at the time, colloquially **"las Arrastradoras"** (Spanish for "the Haulers," reflecting Belgrano's founding Argentine heritage), rudimentary by later standards but a genuine local advance on the basic Soviet-derived Kharkovchanka design the Argentine Air Force would have had records of. Over the generations since, as the vehicle type spread and was built by non-Spanish-speaking cities across Tepenia, "Arrastradoras" wore down into something easier for any speaker to say: **"Rastra"** — short, punchy, phonetically simple enough to cross language lines cleanly, and the name that stuck internationally even as "Arrastradoras" remained the term of record in Belgrano itself. The word outlived its original vehicle, too *(established 2026-07-03)*: once Tepenia reached orbit, "Rastra" was repurposed for small space vehicles — tugs, shuttles, maintenance craft — the same short, easy-to-say word doing service on the ground and off it, generations apart. An all-robot expedition team drove the original Arrastradoras from Belgrano across the West Antarctic interior, following the combined records of all three settlements — robot crews chosen deliberately for a genuinely dangerous first crossing of unmapped, hazardous territory, where cold exposure and mechanical failure risked lives that couldn't be risked as freely.
