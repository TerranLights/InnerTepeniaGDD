...
- **The {{currently-unnamed Korean city}} relationship** — *(corrected 2026-07-13 — this entry previously called Soyuz "Russian-founded" and "the other major Russian city in Tepenia," and asked about contact "between the two Russian communities." Both wrong. The city (files: Soyuz) is singularly Korean-founded via the Jeju-do diplomatic partition — Russia was never more than the physical Progress Station's operator, a GPS fact, never a founding population; Russia sits at ordinary Significant tier there (6.85%), the same non-founding status it holds here at Mirny. There is no "two Russian cities" relationship to develop; whatever genuine connection exists is between two cities' own separate, ordinary Russian-descended minority communities, not a shared founding identity. See `Specs/Soyuz.md` and `Mirny_Full_Extrapolation.md` Section VIII, corrected 2026-07-13 during Shirayuki's own re-check, for the fuller resolution.)* Soyuz was resolved as damaged-but-functional back on 2026-07-03 (effectively co-located with Zhongshan, differing outcomes made no physical sense), and as of 2026-07-05, Soyuz has moved into the Mirny subnet itself, alongside Zhongshan and Shirayuki — no longer a separate-subnet relationship at all, but an internal one. What contact existed between Mirny's and {{currently-unnamed Korean city}}'s own, separate Russian-descended minority communities before the Split Brain, and what their relationship looks like now that the two cities share the same subnet, is still open.
