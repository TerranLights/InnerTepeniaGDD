...
- **The Soyuz relationship** — Soyuz (Russian-founded, based on Progress Station, Larsemann Hills) is the other major Russian city in Tepenia. **Corrected 2026-07-05:** this entry previously said Soyuz was destroyed and asked what Mirny "feels about Soyuz's destruction" — both wrong. Soyuz was resolved as damaged-but-functional back on 2026-07-03 (effectively co-located with Zhongshan, differing outcomes made no physical sense), and as of 2026-07-05, Soyuz has moved into the Mirny subnet itself, alongside Zhongshan and Shirayuki — no longer a separate-subnet relationship at all, but an internal one. What contact existed between the two Russian communities before the Split Brain, and what their relationship looks like now that they share the same subnet, is still open.
