...
Home to the real "Keep Austin Weird" identity — a prosperous, orderly economic mainstream (the "Silicon Hills" tech and semiconductor industry, grown out of university research since the 1960s) that not only tolerates but actively treasures a loud, colorful counterculture running alongside it as part of the city's own self-image, rather than suppressing it.

**What this gives Zhongshan:** concrete real-world precedent for the established relationship between Zhongshan's austere mainstream and its Southeast Asian-inflected counterculture districts (Section 19) — "fully aware of and largely ignores," per the Local Cultures file, is close to a direct match for Austin's own real civic relationship to its "weird" side: not suppressed, not embraced loudly either, just a permanently tolerated pressure valve the mainstream doesn't feel threatened by. Austin's tech-hub economic anchor also grounds Zhongshan's own established ~35% technical/scientific industry dominance.

### Secondary: Yekaterinburg
...
# Zhongshan — Full Extrapolation

**What this is:** every genuinely open question about Zhongshan given an actual proposed answer, built as far as possible directly out of what's already established rather than invented from nothing. Not locked canon — meant for review, revision, or rejection piece by piece. Companion to `Zhongshan_Mega_Init.md` in this same folder. Written 2026-07-07. Given how developed this city already is, this document resolves placeholders rather than inventing large new structure.

---

## I. Demonym: Zhongshanese

Following the Chinese place-name demonym convention already familiar in English (Cantonese, Shanghainese, Taiwanese) rather than the "-er" suffix floated as a candidate in `Specs/Zhongshan.md` — **Zhongshanese**, matching the city's own deep, unbroken Chinese cultural continuity.

---

## II. Notable Figures (proposed, unconfirmed)

- **Founding Elder Mèi Sun** *(placeholder)* — credited with choosing the name Zhongshan itself and articulating the founding political stance (*we kept the name; we did not keep them*); considered the city's moral anchor per the existing placeholder description.
...
## III. Notable Landmarks (proposed, unconfirmed)
...
## Finding 2: the counterculture district's own namelessness is the non-prying norm applied at civic scale

**Combining:** Austin's real "Keep Austin Weird" dynamic, where a mainstream culture tolerates and even quietly values a counterculture without needing to formalize or spotlight it + Zhongshan's own established non-prying social contract (Section 6 of the Local Cultures file) + the newly-proposed "Loud Quarter," deliberately left without an official name (Full Extrapolation, Section III).

**2nd-order effect:** the counterculture district's lack of a formal name isn't an oversight — it's the same "what happens in your neighborhood is your business" logic that governs individual privacy in Zhongshan, applied to an entire district rather than to a single person.

**3rd-order effect:** this means Zhongshan's relationship to its own counterculture runs on the identical mechanism (non-acknowledgment as respect, not indifference) that governs person-to-person privacy elsewhere in the city — the same civic principle operating at two different scales without anyone having deliberately designed it twice.

**4th-order effect:** this is a genuinely elegant piece of internal consistency worth keeping in mind for any future writing involving the district — a formal renaming or official designation would actually be a violation of one of Zhongshan's own established core values, not a neutral administrative act, giving a plausible in-world reason a character might resist "cleaning up" or formalizing the district's status.

---

## Finding 3: the oldest parts of the city carry the deepest war damage, not the newest
...
**4th-order effect:** this gives a concrete, checkable spatial logic for any future depiction of Zhongshan's war damage — the oldest, most "official" parts of the city would show more visible damage than the newer, organic outer rings, an inversion of the usual assumption that older infrastructure is the most solid, worth keeping in mind if this city is ever developed further for level design or environmental storytelling.
...
Finding 2 is the most quietly significant — a formally-unnamed counterculture district as an *active expression* of the city's core social contract, rather than administrative neglect, is exactly the kind of detail that rewards a player who's paying attention to Zhongshan's internal logic rather than assuming every unlabeled thing in the world is simply unfinished.

---

# Zhongshan — Community Infrastructure & Social Life

**What this is:** concrete physical spaces, small institutions, and recurring social rituals that give Zhongshan's already-established culture a tangible, ground-level presence — the same pass done for each of Concordia's 13 districts and for Mirny, Casey, Davis, Kunlun, Shirayuki, Sinheung, and Vostok, extended here. This closes out the Mirny subnet. Drawn from `Zhongshan_Mega_Init.md`, `Zhongshan_Full_Extrapolation.md`, `Zhongshan_Cross_Reference_Synthesis.md`, and `Local_Cultures/Mirny_Subnet/Zhongshan.md`. Written 2026-07-30.

---

## Additions

- **The Founding Hall** — the preserved original Zhongshan Station structure, integrated into the city's core.
- **The Long Record** — the city's primary archive, custodian of the most complete pre-Split-Brain history in the Mirny subnet.
- **The Standing Stone** — the exposed bedrock outcrop around which early construction organized itself, now an informal gathering site.
- **The Crossing Quarter** — the artisan neighborhood where woodworkers, ceramicists, and metalworkers concentrate.
- **The Loud Quarter** — the counterculture district, deliberately without an official name.
- **The Mending Houses** — dedicated garment-repair workshops, where Zhongshan's clothing-maintenance value is practiced as genuine craft.

## Small offices for educational training

- precision manufacturing and technical craft, via the Crossing Quarter tradition
- garment repair and maintenance craft
- fermentation, preservation, and Prydz Bay fishing technique

## Social cohesion mechanisms

- **Dumpling Arguments** — the local institution of neighborhood-by-neighborhood disagreement over the correct jiaozi, a low-stakes outlet in a culture that otherwise doesn't argue in public.
- **The Long Winter Suite Performance** — the recurring performance of the city's defining multi-movement composition, timed to the polar night's roughly 60-day arc.
- **Standing Stone Gatherings** — informal community gatherings at the bedrock outcrop.
- **Tea Ceremony Suppers** — the unhurried, long-meal tradition where care is expressed through preparation rather than words.

---

## Worth Your Attention

Dumpling Arguments is the standout item — it takes an already-vivid, fully-developed piece of established culture (Local Cultures Section 10) and gives it formal standing as a named social mechanism, exactly the kind of low-stakes, characterful starting point a questline could open on.
