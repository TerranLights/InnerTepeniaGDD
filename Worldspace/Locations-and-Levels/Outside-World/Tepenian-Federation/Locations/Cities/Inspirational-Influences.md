...
- Potala Palace, Tibet [SECONDARY]
- Angkor Wat, Cambodia [SECONDARY]
...
##### Esperanza
- The Basque baserri tradition, Spain/France [PRIMARY] // ⭐ *ranked first of Esperanza's three Primary picks — carried a non-standard top-primary tier token until 2026-09-05, the only one in the file; normalized so a mechanical tier sweep reads it, with the ranking preserved here as prose.* family farmsteads built and inherited specifically to sustain multiple generations working the same land together; parents choose one child — not necessarily eldest, not necessarily a son — to inherit and keep the household intact rather than divided
