# Dumont d'Urville — development pass
...
| | |
|---|---|
| **Spec** | `../../../Specs/Dumont_dUrville.md` |
| **Local culture** | `../../../Local_Cultures/Janbogo_Subnet/Dumont_dUrville.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Dumont_dUrville.md` |
| **Research log** | `../../../Research_Logs/Dumont_dUrville_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
