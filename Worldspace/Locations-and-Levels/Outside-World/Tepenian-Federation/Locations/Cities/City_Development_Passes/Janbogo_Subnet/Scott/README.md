...
|---|---|
| **Spec** | `../../../Specs/Scott.md` |
| **Local culture** | `../../../Local_Cultures/Janbogo_Subnet/Scott.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Scott.md` |
| **Research log** | `../../../Research_Logs/Scott_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
