...
| | |
|---|---|
| **Spec** | `../../../Specs/Fort_McMurdo.md` |
| **Local culture** | `../../../Local_Cultures/Janbogo_Subnet/Fort_McMurdo.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Fort_McMurdo.md` |
| **Research log** | `../../../Research_Logs/Fort_McMurdo_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
