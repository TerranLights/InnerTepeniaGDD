...
|---|---|
| **Spec** | `../../../Specs/Byrd.md` |
| **Local culture** | `../../../Local_Cultures/Byrd_Subnet/Byrd.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Byrd.md` |
| **Research log** | `../../../Research_Logs/Byrd_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
