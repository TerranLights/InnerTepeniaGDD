...
|---|---|
| **Spec** | `../../../Specs/Sanay.md` |
| **Local culture** | `../../../Local_Cultures/Halley_Subnet/Sanay.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Sanay.md` |
| **Research log** | `../../../Research_Logs/Sanay_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
