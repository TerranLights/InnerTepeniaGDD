...
|---|---|
| **Spec** | `../../../Specs/Troll.md` |
| **Local culture** | `../../../Local_Cultures/Halley_Subnet/Troll.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Troll.md` |
| **Research log** | `../../../Research_Logs/Troll_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
