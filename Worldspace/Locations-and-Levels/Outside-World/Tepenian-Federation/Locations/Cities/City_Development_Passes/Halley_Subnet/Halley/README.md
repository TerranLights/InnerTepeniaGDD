...
| | |
|---|---|
| **Spec** | `../../../Specs/Halley.md` |
| **Local culture** | `../../../Local_Cultures/Halley_Subnet/Halley.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Halley.md` |
| **Research log** | `../../../Research_Logs/Halley_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
