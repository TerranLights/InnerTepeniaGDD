...
| | |
|---|---|
| **Spec** | `../../../Specs/Neumayer.md` |
| **Local culture** | `../../../Local_Cultures/Halley_Subnet/Neumayer.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Neumayer.md` |
| **Research log** | `../../../Research_Logs/Neumayer_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
