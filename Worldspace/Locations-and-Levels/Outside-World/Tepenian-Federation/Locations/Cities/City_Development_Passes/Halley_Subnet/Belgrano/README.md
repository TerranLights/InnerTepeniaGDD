...
| | |
|---|---|
| **Spec** | `../../../Specs/Belgrano.md` |
| **Local culture** | `../../../Local_Cultures/Halley_Subnet/Belgrano.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Belgrano.md` |
| **Research log** | `../../../Research_Logs/Belgrano_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
