...
| | |
|---|---|
| **Spec** | `../../../Specs/Mawson.md` |
| **Local culture** | `../../../Local_Cultures/Mawson_Subnet/Mawson.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Mawson.md` |
| **Research log** | `../../../Research_Logs/Mawson_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
