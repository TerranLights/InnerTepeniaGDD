...
| | |
|---|---|
| **Spec** | `../../../Specs/Sayowa.md` |
| **Local culture** | `../../../Local_Cultures/Mawson_Subnet/Sayowa.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Sayowa.md` |
| **Research log** | `../../../Research_Logs/Sayowa_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
