...
|---|---|
| **Spec** | `../../../Specs/Davis.md` |
| **Local culture** | `../../../Local_Cultures/Mirny_Subnet/Davis.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Davis.md` |
| **Research log** | `../../../Research_Logs/Davis_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
