...
| | |
|---|---|
| **Spec** | `../../../Specs/Shirayuki.md` |
| **Local culture** | `../../../Local_Cultures/Mirny_Subnet/Shirayuki.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Shirayuki.md` |
| **Research log** | `../../../Research_Logs/Shirayuki_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
