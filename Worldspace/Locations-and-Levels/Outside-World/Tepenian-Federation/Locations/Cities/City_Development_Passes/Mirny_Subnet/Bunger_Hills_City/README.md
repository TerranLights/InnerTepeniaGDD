# Bunger Hills City — development pass
...
| | |
|---|---|
| **Spec** | `../../../Specs/Bunger_Hills_City.md` |
| **Local culture** | `../../../Local_Cultures/Mirny_Subnet/Bunger_Hills_City.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Bunger_Hills_City.md` |
| **Research log** | `../../../Research_Logs/Bunger_Hills_City_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
