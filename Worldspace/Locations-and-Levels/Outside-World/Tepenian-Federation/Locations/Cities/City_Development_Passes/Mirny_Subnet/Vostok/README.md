...
| | |
|---|---|
| **Spec** | `../../../Specs/Vostok.md` |
| **Local culture** | `../../../Local_Cultures/Mirny_Subnet/Vostok.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Vostok.md` |
| **Research log** | `../../../Research_Logs/Vostok_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
