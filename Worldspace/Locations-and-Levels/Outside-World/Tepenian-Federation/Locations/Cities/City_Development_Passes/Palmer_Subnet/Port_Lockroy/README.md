...
| | |
|---|---|
| **Spec** | `../../../Specs/Port_Lockroy.md` |
| **Local culture** | `../../../Local_Cultures/Palmer_Subnet/Port_Lockroy.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Port_Lockroy.md` |
| **Research log** | `../../../Research_Logs/Port_Lockroy_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
