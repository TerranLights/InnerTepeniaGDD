...
| | |
|---|---|
| **Spec** | `../../../Specs/Juan_Carlos.md` |
| **Local culture** | `../../../Local_Cultures/Palmer_Subnet/Juan_Carlos.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Juan_Carlos.md` |
| **Research log** | `../../../Research_Logs/Juan_Carlos_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
