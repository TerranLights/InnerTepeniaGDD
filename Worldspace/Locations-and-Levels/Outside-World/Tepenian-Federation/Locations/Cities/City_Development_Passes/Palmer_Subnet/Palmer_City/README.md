...
| | |
|---|---|
| **Spec** | `../../../Specs/Palmer_City.md` |
| **Local culture** | `../../../Local_Cultures/Palmer_Subnet/Palmer_City.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Palmer_City.md` |
| **Research log** | `../../../Research_Logs/Palmer_City_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
