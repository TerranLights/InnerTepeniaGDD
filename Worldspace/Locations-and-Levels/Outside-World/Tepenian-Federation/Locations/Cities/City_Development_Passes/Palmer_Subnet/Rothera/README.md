...
| | |
|---|---|
| **Spec** | `../../../Specs/Rothera.md` |
| **Local culture** | `../../../Local_Cultures/Palmer_Subnet/Rothera.md` ⚠ *Amundsen Station and Concordia do NOT follow this pattern — read by name* |
| **Vision notes** | `../../../City_Vision_Notes/Rothera.md` |
| **Research log** | `../../../Research_Logs/Rothera_Research_Log.md` ⚠ *may not exist yet — Step F creates it* |
