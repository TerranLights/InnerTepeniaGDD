...
- Resolved: Bharati Station site (founding population Japanese, via Jeju-do allocation, settled 2026-07-03) → **Shirayuki** ✓ *(named 2026-07-08)*

**Status key:**
- **Destroyed** — Long Night War (coastal, targeted by Upper Earth militaries)
- **Damaged; partially operational** — Hit during the Long Night War but not fully leveled; sections surviving or in partial use
...
| Real Station | Country | Tepenian City Name | Status | Notes |
|---|---|---|---|---|
| Halley Stations I–VI | UK | **Halley** ✓ | Damaged; partially operational | Built on floating ice shelf — structurally unusual; confirmed Arcanet subnet hub; DLC 5 anchor |
| Belgrano Station II | Argentina | **Belgrano** ✓ | Damaged; partially operational | Confirmed city name; Salagéa Aparast's origin city; DLC 5 content |
...
| Real Station | Country | Tepenian City Name | Status | Notes |
|---|---|---|---|---|
| Mirny Station | Russia | **Mirny** | Damaged; partially operational | Confirmed Arcanet subnet hub; primary refugee source — organized evacuation implied, not instant obliteration |
| Casey Station | Australia | Casey | Destroyed | Specifically targeted to sever Concordia's eastern coastal access |
| Dumont d'Urville Station | France | Dumont d'Urville | Damaged; partially operational | French station; TBN Pink Lucy (FW-25)'s origin city; organized evacuation confirmed |
| Cape Denison | Australia | Denison | Destroyed | Founded on Mawson's 1912 expedition base; destroyed Long Night War |
...
| Real Station | Country | Tepenian City Name | Status | Notes |
|---|---|---|---|---|
| Jang Bogo Station | Unified Korea | **Janbogo** ✓ | Damaged; partially operational | Confirmed; supplies Concordia; source of refugees; DLC 6 primary city |
| McMurdo Station | USA | **Fort McMurdo** ✓ | Damaged; partially operational | Largest pre-war Tepenian city; mining and resource-processing hub; significant ruins with partially functional sections; "Fort" = reference to Fort MacMurray (Alberta) |
| Scott Base | New Zealand | Scott | Damaged; partially operational | Adjacent to Fort McMurdo on Ross Island; effectively twin cities |
| Mario Zucchelli Station | Italy | **Zukelli** ✓ | Destroyed | Southern terminus of Hwy 183 |
| Cape Adare | Various | Cape Adare | Destroyed | Founded on earliest Antarctic expedition landing site; destroyed Long Night War |
...
| Real Station | Country | Tepenian City Name | Status | Notes |
|---|---|---|---|---|
| Amundsen-Scott South Pole Station | USA | **Amundsen Station** ✓ | Destroyed | Site of the Amundsen Tower (space elevator); now a scrap mountain; most significant ruins in Tepenia; DLC 1 setting |
...
*(Pre-exile bases; not modern research stations; ruins or memorial sites in game)*
...
- **Fort McMurdo's "Fort" prefix** — confirmed: mining and resource-processing city; also a deliberate reference to Fort MacMurray (Alberta, Canada), a remote industrial boomtown.
