# Antarctic Station → Tepenian City Reference
...
- **Survived** — Inland, not targeted or not reachable
- **Too high** — Inland but altitude too extreme for viable large settlement
- **Historical site** — Pre-exile expedition base; ruins/memorial rather than functioning city
- **TBD** — Status not yet determined

**Confirmed names are marked ✓. All others are suggested and subject to developer approval.**

---

## Antarctic Peninsula
*(Facing South America / Atlantic; most accessible from Upper Earth; Palmer City was here)*
...
## Queen Maud Land / King Haakon VII Sea
*(Facing the Atlantic; Norwegian territorial claim)*

| Real Station | Country | Tepenian City Name | Status | Notes |
|---|---|---|---|---|
| Neumayer Station III | Germany | **Neumayer** ✓ | Destroyed | Confirmed city name |
| Sanae IV Station | South Africa | Sanae | Destroyed | South African presence in Tepenia |
| Troll Base | Norway | Troll | Destroyed | Norwegian station; runway access |
| Aboa Station | Finland | Aboa | Destroyed | Finnish station; seasonal in real life — possibly smaller settlement |
| Maitri Station | India | Maitri | Destroyed | Indian station; "Maitri" means friendship in Sanskrit |
| Princess Elizabeth Station | Belgium | Princess Elizabeth | Destroyed | Belgian station; zero-emission design in real life — possibly energy-conscious city |

---

## Indian Ocean Coast / East Antarctica

| Real Station | Country | Tepenian City Name | Status | Notes |
|---|---|---|---|---|
| Syowa Station | Japan | Syowa | Destroyed | Japanese station; significant Japanese presence in Tepenia alongside Unified Korea |
| Soyuz Station | Russia | Soyuz | Destroyed | Russian station, East Antarctic coast |
| Mawson's Huts / Mawson Station | Australia | Mawson | Destroyed | Mawson is a confirmed Arcanet subnet; historically significant name |
| Bharati Station | India | Bharati | Destroyed | India's second Antarctic station |
| Zhongshan Station | Sinian Federation | Zhongshan | Destroyed | Sinian Federation station; named after Sun Yat-sen |
| Davis Station | Australia | Davis | Destroyed | Major Australian station |

---

## Dumont d'Urville Sea / East Antarctic Coast
*(Primary source of refugees reaching Concordia)*

| Real Station | Country | Tepenian City Name | Status | Notes |
|---|---|---|---|---|
| Mirny Station | Russia | **Mirny** | Destroyed | Confirmed Arcanet subnet; primary source of refugees reaching Concordia |
| Casey Station | Australia | Casey | Destroyed | Major Australian station |
| Dumont d'Urville Station | France | Dumont d'Urville | Destroyed | French station; the Dumont d'Urville Sea is named after this area |
| Cape Denison | Australia | Cape Denison | Historical site | Mawson's 1912 expedition base; pre-exile ruins |

---

## Ross Sea / Pacific Coast
...
| Real Station | Country | Tepenian City Name | Status | Notes |
|---|---|---|---|---|
| Amundsen-Scott South Pole Station | USA | **Amundsen Station** ✓ | Destroyed | Site of the Amundsen Tower (space elevator); now a scrap mountain; the most significant ruins in Tepenia |
...
## Historical / Expedition Bases
*(Pre-exile bases; not modern research stations; likely ruins or memorial sites in game)*
...
- **Confirmed destroyed (coastal, Long Night War):** majority
- **Confirmed survived (inland):** Concordia (game setting), Vostok (isolated), Dome Fuji (too high), Kunlun (too high)
- **Status unclear:** Byrd Station, some historical sites
- **Confirmed Arcanet subnets** (already named in lore): Palmer, Halley, Mawson, Mirny, Janbogo, Byrd
- **Primary refugee source for Concordia:** Dumont d'Urville Sea coast and Ross Sea/Pacific coast (closest to Concordia's longitude)
...
- **The Arcanet subnet cities** — Palmer, Halley, Mawson, Mirny, Janbogo, and Byrd are confirmed as Arcanet subnet hubs. These were the communication nodes of Tepenia, which tells us something about their relative importance and size.
