# Zukelli — Developer Vision Notes

**Purpose:** A running record of the developer's own creative vision for this city — distinct from `Specs/Zukelli.md` (established facts) and `Local_Cultures/Janbogo_Subnet/Zukelli.md` (32-section post-culture spec). This file captures open questions asked, answers given, and anything newly established through direct conversation, so it can be referenced later and folded into the more formal files when ready.
...
- The defectors' nationality/military of origin, how many defected, exact timing within the war (see Janbogo's own file for the fuller list of open questions from this resolution)
