# Kunlun — Developer Vision Notes

**Purpose:** A running record of the developer's own creative vision for this city — distinct from `Specs/Kunlun.md` (established facts) and `Local_Cultures/Mirny_Subnet/Kunlun.md` (32-section post-culture spec). This file captures open questions asked, answers given, and anything newly established through direct conversation, so it can be referenced later and folded into the more formal files when ready.
...
**Endless scientific hardware kept inside buildings to protect them from the cold.** A massive, gigantic antenna towers high over the actual city, along with satellites to measure space. Inside the various buildings are endless rooms of scientific hardware with holographic displays for analyzing results. There's a general culture of curiosity and interest about the city. Nobody really thinks of what they're doing here as a "job" — from their perspective, this isn't work, it's life; this is what they do. Because of this, a lot of the "after-work leisure" (bars, music halls, restaurants) tends to be open and operational 24 hours a day, since no matter what time it is, there will be robots working on something scientifically-related.
...
**Follow-up asked:** is there a specific thing residents are actively looking for or working toward with the observatory, or is it more diffuse, open-ended research? **Answer:** not entirely certain, but leaning toward Kunlun's observatory focusing more on near-Earth objects of interest (Mars, the Moon, similar) than on distant star systems — tentative, not firmly settled.
