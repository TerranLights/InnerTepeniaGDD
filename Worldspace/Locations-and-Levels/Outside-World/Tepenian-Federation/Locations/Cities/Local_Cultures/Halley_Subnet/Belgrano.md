# Belgrano — Cultural Spec Sheet

---

**Subnet:** Halley ("Atlantic")
**Status:** Ruins — survived the Long Night War intact, then declined into ruin in the decades after; still inhabited (DLC 5)
...
- **a. Primary language(s):** English (American-inflected, reflecting long-run demographic majority) and German are most widely spoken; Spanish survives specifically among families tracing lineage to the founding Argentine population, often as a heritage/ceremonial language rather than a daily one.
- **b. Linguistic character:** Clipped, functional, low on embellishment — communication in Belgrano optimizes for clarity and speed, a linguistic register that reads almost military to outsiders. Long sentences are rare; nobody has the infrastructure margin for imprecision.
- **c. Slang / dialect markers:** Aviation and maintenance terminology bleeds into everyday speech — residents describe emotional and social situations using the vocabulary of equipment status and operational readiness. Describing a person as "still airworthy" is a genuine, sincere compliment.
- **d. Language and integration:** Minimal pressure; a population this small and this focused on survival has no bandwidth to police anyone's accent or fluency. Being useful matters more than speaking correctly.
...
Belgrano-descended people in Concordia carry a specific, doubled grief uncommon even among Tepenia's many displaced populations: their city wasn't destroyed in the war that destroyed so much else — it survived, and then it died anyway, slowly, in a way that offers no clean villain and no clear moment of loss to point to. This produces a particular relationship to endurance: Belgrano people in Concordia tend to be blunt, functionally minded, allergic to performative comfort, and quietly, deeply committed to not letting things fall apart on their watch — because they know, better than almost anyone else in Tepenia, exactly what it looks like when they do.
