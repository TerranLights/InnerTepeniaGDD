# Tepenian City Local Cultures

This directory contains culture spec sheets for each Tepenian city — the composite, emergent post-cultures that developed from each city's specific national/ethnic population mix coexisting under Antarctic conditions over generations.
...
*Inter-subnet relay outpost; ~81% robot population; not a residential city*
