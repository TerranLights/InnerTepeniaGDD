# Soyuz — Cultural Spec Sheet

*(Note: this sheet was originally written under the assumption that Soyuz was destroyed in the Long Night War. That status was corrected 2026-07-03 — Soyuz is damaged but partially operational, resolved consistently with its effectively co-located neighbor Zhongshan. The living-culture content below is unaffected by the correction; only status-specific framing, below and in Section 30, has been updated.)*
