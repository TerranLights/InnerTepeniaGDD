...
- **Concordia:** The most structurally significant relationship of any city in this comparison set — Mirny and Concordia share a subnet, meaning the intra-subnet Arcanet link between them survived the Planetary Split Brain that severed every inter-subnet connection. If functional even partially, Mirny's voice is the only external voice Concordia can still hear in real time — a genuinely unique relationship, unmatched by any trade or diaspora tie any other city in this project has to Concordia.

---

## 24. Arcanet Culture

The single most distinctive fact about Mirny in all of Tepenia: as the Mirny subnet hub, its Arcanet link to Concordia survived the Planetary Split Brain, which severed every other inter-subnet connection in the Federation. Mirny's Arcanet culture is accordingly weighted heavily toward infrastructure, relay maintenance, and the sober responsibility of potentially being Concordia's only real-time external contact. Whether this link is actually functioning, given Mirny's damaged post-war state, is unresolved — but the city's entire relationship to its own communications network carries a gravity no other city's Arcanet culture in this project shares.
...
- **The Mirny subnet relay hardware** — the physical Arcanet infrastructure making Mirny the hub of the entire subnet, and its last-standing link to Concordia
