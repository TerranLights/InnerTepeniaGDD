...
- **c. Production sets the tempo** — The fabrication economy's own rhythm (raw materials in from Mirny, finished goods and fabrication-synthesis chambers out) paces daily life more than the oasis's own mild climate would otherwise suggest. *(Corrected 2026-07-16 — previously "from Davis"; see `Specs/Sinheung.md`'s Economy & Industry section for the reassignment.)*
...
- Finished fabricated goods generally — raw materials arrive from Mirny, leave the city as usable product. *(Corrected 2026-07-16 — previously "from Davis.")*
