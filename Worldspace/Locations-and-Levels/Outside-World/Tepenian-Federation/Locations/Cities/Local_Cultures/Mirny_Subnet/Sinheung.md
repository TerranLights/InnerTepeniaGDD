# Sinheung — Cultural Spec Sheet

*(Note: this sheet was originally written under the placeholder label "Sinheung," and under the assumption that the city was destroyed in the Long Night War. The war-status question was corrected 2026-07-03 — the city is damaged but partially operational, resolved consistently with its effectively co-located neighbor Zhongshan. The name question was resolved separately, 2026-07-14 — see Section 2 and the One-liner below. The living-culture content throughout is unaffected by either correction; only naming and status-specific framing has been updated.)*
...
**Status:** Damaged; partially operational *(corrected 2026-07-03 from "destroyed" — see note above and `Specs/Sinheung.md`)*
...
**One-liner:** *A Korean city that inherited a Russian station's leftover name along with its infrastructure, carried it for generations of in-world development before finally choosing its own — Sinheung, "newly rising" — a claim secured by treaty rather than found, in the densest multinational cluster the Mirny subnet has, badly hit by the Long Night War but standing still, alongside its effectively co-located neighbor Zhongshan.* **(Corrected 2026-07-14 — the city's own name is now resolved; corrected 2026-07-13 — this line previously said the city "named itself after a spacecraft... ambition chosen deliberately over nostalgia," the exact self-naming error already fixed everywhere else in this file.)**
...
- **Industrial fabrication: 45%** — raw materials trucked in from Davis (via the Hwy 110/Hwy 4 tri-junction at Zhongshan) and fabricated into finished goods. Most significantly, **Sinheung is one of a handful of Tepenian cities that manufactures "fabrication-synthesis chambers"** (placeholder name, pending refinement) — the actual apparatus that creates robots. These chambers are shipped nationwide from Sinheung and the handful of other cities that produce them, meaning a robot can be "born" (built) in any Tepenian city regardless of whether that city has its own chamber-manufacturing capability. This is a foundational piece of how robot creation works across Tepenia, not a Sinheung-specific curiosity — see `Robot_Biology_and_Culture/Robot_Physiology_and_Cultural_Practices.md` for cross-reference once developed further.
