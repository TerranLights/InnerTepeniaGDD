# Sejong — Cultural Spec Sheet

*(Written as a living, active city per the project's methodology note — Sejong is destroyed in the game's present era, but this document describes its culture while populated and functioning. See `Specs/Sejong.md` for its destruction, and `Local_Cultures/README.md` for the present-tense methodology.)*
...
**Census Population:** 316,691 humans / 328,142 robots / 644,833 combined (Census I, rank 21st, *corrected 2026-07-03, again 2026-07-05*); 234,304 humans / 279,766 robots / 514,070 combined (Census II, rank 21st, *corrected 2026-07-17 — was "20th," stale against the current Official_Population_Census.md Census II ranking table*)
...
King George Island's founding was unlike any other Tepenian city's: multiple national exile communities arrived to find the island already dense with pre-existing research infrastructure — Korean, Chinese, Argentine, Brazilian, Chilean, Polish, Russian, Czech, and Uruguayan stations had all operated within close proximity of each other before the exile era began. Sejong was the Korean settlement, surrounded from day one by neighbors representing nearly a dozen other nations, all sharing an island roughly 80km long.
...
Janbogo on the Ross Sea coast and Sejong on King George Island were both founded by Korean exiles and both named after Korean historical figures — a shared founding-era choice, not an ongoing shared identity. *(Corrected 2026-07-13: over roughly two and a half centuries, Janbogo remained a genuine Korean demographic and cultural center in Tepenia — alongside Sinheung in the Mirny subnet, singularly Korean-founded via the Jeju-do partition and still Korean-Primary at 34.62% — while Sejong's own Korean population diluted to just 5.79%, its smallest Significant-tier nation, dwarfed by the USA's sole-Primary 21.65%, under the same extreme King George Island immigration density that shaped everything else about this city. Sejong's story diverged sharply from Janbogo's after their shared naming moment; they are not, any longer, the same people's story told twice.)*

---

## 3. Climate Character

King George Island sits well north of the Antarctic Circle, giving Sejong the mildest climate of any Palmer subnet city — no polar night, no midnight sun, and above-freezing temperatures a regular summer occurrence. The Drake Passage and Bransfield Strait create a genuinely maritime environment, wetter and milder than the Peninsula mainland itself.

---

## 4. Seasonal Rhythms

Without polar night or midnight sun, Sejong's rhythm follows the practical realities of a dense, multinational island rather than any light cycle — coordination across a dozen neighboring national communities, all sharing weather, infrastructure, and the same stretch of favorable, accessible ground.
...
- **e. Privacy as civic value** — Moderate; a city constantly aware of its neighbors doesn't have the luxury of full anonymity, but internal community life retained real privacy.

---

## 7. Who This City Attracts

- **The type this city draws:** people comfortable with dense multinational proximity and constant boundary negotiation — a genuinely different skill set from most Tepenian cities' more singular national character.
- **The type this city repels:** anyone seeking cultural isolation or a simple, uncontested national identity — Sejong never had the luxury of either.
...
Distinctly bounded and transitional — Sejong's built environment gave way at clear boundary zones to its neighboring national communities' own architectural traditions, creating one of the most architecturally varied and culturally layered landscapes in all of Tepenia, concentrated on a single, relatively small island.
...
- **Sound:** Genuinely multilingual, the most linguistically layered soundscape of any Palmer subnet city.
- **Smell:** Mild, maritime, the most physically comfortable conditions in the subnet.
- **Feel:** Constantly relational — Sejong never felt isolated the way more remote Tepenian cities did; the presence of so many neighbors was always part of the experience.
- **First impressions for visitors:** The genuinely mild climate first, then quickly the sheer density and variety of national communities packed onto a single island.
...
Robot culture at Sejong likely developed genuine cross-cultural competence out of necessity — operating within a dense multinational island meant robots here needed fluency across multiple national contexts in a way most Tepenian cities' robot populations never required.
...
Modest — a city this densely interwoven with its neighbors doesn't have much room for isolated counterculture; whatever friction exists plays out at the inter-community boundary level rather than as an internal Korean subculture.

---

## 20. Private Life & Minority Communities

The broad Significant tier (Germany, France, UK, Italy, South Korea, Russia, Mexico, Brazil) reflects genuine demographic complexity — Sejong's private cultural life operates at multiple simultaneous registers, Korean and otherwise, given the island's whole multinational character.
...
Genuinely complex, given the island's dense multinational character — Arcanet use here likely required navigating information flows across multiple national communities simultaneously, a structural complexity unique to Sejong within the Palmer subnet.

---

## 25. Export Culture

- The King George Island coexistence model — cited elsewhere in Tepenia as either a successful experiment in dense multinational cohabitation or a cautionary tale, depending on how that history is ultimately resolved
- Genuine cross-cultural competence — Sejong-trained diplomats and cultural liaisons
- A specific *type of person* — comfortable with constant relational identity negotiation, recognizable by an ease with multinational density that even Palmer City's cosmopolitanism doesn't quite match

---

## 26. Municipal Holidays

- **Hangul Day** *(placeholder name)* — honoring King Sejong the Great's creation of the Korean alphabet
- **The Neighbors' Accord** *(placeholder name)* — an observance marking the ongoing, practiced coexistence with King George Island's other national communities
...
The mild climate registers first, followed immediately by the genuinely unusual experience of a densely multinational island — a visitor here encounters more distinct national communities in immediate proximity than anywhere else in Tepenia, Palmer City included.

---

## 28. The Visitor-to-Resident Transition

Becoming a local at Sejong meant learning not just Korean community life but the constant, practiced diplomacy of coexisting with a dozen immediate national neighbors — a genuinely more complex integration than most Tepenian cities require.
...
- **The multinational district boundary zones** — the negotiated edges where Sejong's territory met its many neighbors
- **King George Island harbor** — the main maritime entry point, heavily used given the island's accessibility

---

## 30. Significant Local Events

- **The Long Night War destruction** — Sejong was destroyed along with the rest of the Peninsula's first-wave targets. Whether King George Island's other national communities shared Sejong's fate, and what became of the whole multinational coexistence experiment, are open questions for DLC 3 design.
