...
Over the generations that followed, immigration reshaped Mawson's demographics along entirely different lines than the founding Australian population might have expected — not the American wave that reshaped so much of the rest of Tepenia, but a genuinely Indian-Ocean-facing current: Chinese immigration eventually became the demographic Primary, with Japan, South Korea, and Indonesia all establishing real Significant-tier presence alongside it.
...
Mawson's polar night (~36 days) and midnight sun (~37 days) are relatively brief for its latitude, moderated by the Mac.Robertson Land coastal position. As subnet hub, its actual civic rhythm is shaped as much by Arcanet coordination duties as by the seasons themselves — Mawson has always had to keep pace with the whole subnet's information flow, not just its own local calendar.
...
- **a. Primary language(s):** Chinese as the genuine demographic default, with substantial English (Australian founding heritage) and real Japanese/Korean/Indonesian presence given the broad Significant tier.
- **b. Linguistic character** — Genuinely plural, reflecting the Indian-Ocean-facing immigration pattern distinct from the rest of Tepenia's more American-inflected cities.
- **c. Slang / dialect markers** — St. Douglas-related civic vocabulary persists as institutional/ceremonial language even among residents with no Australian ancestry — a naming-and-memory tradition that outlasted the demographic shift that produced it.
- **d. Language and integration** — Moderate pressure, consistent with a genuine subnet hub that needs functional multilingual competence to coordinate across its whole network.
...
- **Visual arts:** Institutional and documentary in character, reflecting the city's whole operational-continuity self-image.
- **Literature:** St. Douglas's own expedition history functions as genuine foundational literature — the 1911–14 Australasian Antarctic Expedition's legacy carried forward as civic mythology regardless of who actually lives in the city today.
- **Crafts & material culture:** Practical, institutionally-minded, shaped by decades of maintaining continuously-operating infrastructure.
...
- No dominant formal religion; St. Douglas veneration is the closest thing to a unifying civic value — genuinely complete in its connection here, since the city, subnet, and surrounding territory all carry his name or legacy regardless of who lives here now.
- A quiet, practiced comfort with demographic change alongside institutional continuity — Mawson's whole civic identity depends on holding both at once.

---

## 19. Underground / Counterculture

Modest — a genuine hub city with real subnet-wide responsibilities doesn't have much organizational slack for counterculture; whatever tension exists (Australian founding memory versus Chinese-Primary demographic present) is openly acknowledged rather than suppressed or organized against.

---

## 20. Private Life & Minority Communities

The broad Significant tier (Japan, Germany, France, UK, South Korea, Indonesia, Australia) and the extensive 18-nation Notable list maintain identity through private, personal practice — Mawson's public civic face is organized around St. Douglas veneration and hub function rather than any single demographic group's heritage.
...
Genuinely significant as the Mawson subnet's administrative and communications heart — before the Planetary Split Brain, Mawson's Arcanet connection to the rest of Tepenia was the subnet's primary link, giving it real political weight distinct from its demographic makeup.
...
- Subnet-hub coordination expertise — Mawson-trained specialists in Arcanet logistics and inter-city coordination
- St. Douglas's legacy — Mawson is the definitive Tepenian site for his veneration, a cultural export to the rest of the subnet and beyond
- A specific *type of person* — comfortable holding institutional continuity and demographic change simultaneously, recognizable by an ease with that duality that few other Tepenian cities require of their residents
...
Becoming a local at Mawson means engaging with both halves of the city's identity — the institutional, St. Douglas-venerating continuity and the lived, genuinely plural demographic present — rather than picking one over the other.
...
As the Mawson subnet's hub, Mawson's name and St. Douglas's legacy are known throughout Tepenia even where its specific demographic reality is not — Concordia knows Mawson as the face of its subnet. Diaspora character would likely reflect the city's genuine plurality: Chinese, Japanese, Korean, Indonesian, and Australian threads all present, alongside an institutional, hub-city competence distinct from more singularly-founded Tepenian cities' refugee communities.
