...
| Location | Pair | Relation | The read |
|---|---|---|---|
...
> way)*, **and its line/character split became `05` §6.1a's line-anchoring sub-rule.** ***Its removal from
> `02` closes that channel at the source rather than mitigating it.***
