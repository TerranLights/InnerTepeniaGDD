...
> **Origin: `/home/kuroskalacs/Documents/Doll-Fi/media/games/Inner Tepenia/InnerTepeniaGDD/Worldspace/Locations-and-Levels/Universal_Location_Methodology/04_QA_Gates_and_Differentiation.md` — lines 353–382.** *(Range refreshed 2026-09-07 — mechanically re-verified against the current file; was `338–367`.)* ***If this file and the source ever disagree, THE SOURCE WINS.***
...
classed *originated* goes to Gate 6** — ⚠ **to its IN-RUN half only** *(within this location; the
against-siblings half is terminal as of 2026-09-06)*. Anything that cannot be classed is a flag — usually it means the parent's
