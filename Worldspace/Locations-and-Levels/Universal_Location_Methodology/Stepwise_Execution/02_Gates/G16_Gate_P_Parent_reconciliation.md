...
> **Origin: `/home/kuroskalacs/Documents/Doll-Fi/media/games/Inner Tepenia/InnerTepeniaGDD/Worldspace/Locations-and-Levels/Universal_Location_Methodology/04_QA_Gates_and_Differentiation.md` — lines 383–398.** *(Range refreshed 2026-09-07 — mechanically re-verified against the current file; was `368–383`.)* ***If this file and the source ever disagree, THE SOURCE WINS.***
