# District-Specific Player Actions
**Positive & Negative Actions That Highlight Unique Identity**

For each district, here are **2–5 specific actions** the player can take that feel very native to that district — both positive (builds reputation) and negative (causes immediate hostility/violence).
...
- **Negative**: Leak highly classified political documents.
- **Negative**: Incite open rebellion inside the governmental district.

### 9. Gemini – Janbogo Subnet Nexus (Information / Communication)
- **Positive**: Help verify and distribute accurate information during a crisis.
- **Positive**: Restore corrupted data archives or communication nodes.
- **Negative**: Deliberately spread dangerous misinformation.
...
- **Negative**: Steal critical survival supplies from fellow explorers.
- **Negative**: Abandon people during a frontier crisis.

### 12. Virgo – Concordia Undergrid (Maintenance / Service)
- **Positive**: Help repair critical life-support systems deep in the tunnels.
- **Positive**: Clear blocked maintenance routes during a collapse.
- **Negative**: Sabotage essential infrastructure (pipes, power, support beams).
...
**Design Note**:  
These actions make the districts feel alive and distinct. Positive actions build deep reputation and open unique questlines. Negative actions can instantly drop reputation to “Hated” and trigger combat with locals.

Would you like me to:
- Turn this into a full Markdown file for your repo?
- Add more actions per district?
- Create a version focused only on hostility triggers?

Just let me know how you want to expand it!
