# Districts by Enneagram groups 
### Purpose of differentiation is to offer the richest roleplaying opportunities along the lines of:
* moral dilemmas
* alliances vs. betrayals
* player agency in supporting/hurting sides
* internal district drama
* external ripple effects
* thematic resonance insofar as:
    * district's orientation
    * features
    * conflicts

### Quick Enneagram Group Definitions (for reference)
* Major Themes (Centers/Triads): Instinctive/Gut (anger-focused: types 8,9,1), Feeling/Heart (shame-focused: 2,3,4), Thinking/Head (fear-focused: 5,6,7).
...
* Harmonic Group: Reactive (or Positive Outlook) — Intense emotional responses to crises, grief, and moral conflicts around who to save. Reactive fits the raw emotional stakes; Positive Outlook appears in healing gardens and bonding ceremonies.
##### Reasoning:
...
* Harmonic Group: Positive Outlook — Strong drive to preserve harmony, coziness, and positive domestic life despite external pressures.
##### Reasoning:
...
* Harmonic Group: Positive Outlook (or Reactive) — Reframing hardship through art and celebration, or intense emotional performances.
##### Reasoning:
...
* Harmonic Group: Reactive — Raw emotional honesty, intensity around truth, rebirth, and vice.
##### Reasoning:
...
* Harmonic Group: Reactive — Intense reactions to shortages, blackouts, and high-stakes decisions.
##### Reasoning:
...
* Harmonic Group: Competency — Focus on doing things “right,” quality vs. quantity, and objective problem-solving.
##### Reasoning:
...
* Harmonic Group: Competency — Emphasis on rational solutions, expertise, and “correct” breakthroughs.
##### Reasoning:
...
* Harmonic Group: Competency (or Reactive) — Objective fairness and rule-following, or intense reactions to injustice.
##### Reasoning:
* The political heart of diplomacy and bureaucracy. Compliant + Thinking + Competency groups excel here in stories of central planning vs. district autonomy, transparency vs. secrecy, equal vs. merit-based allocation, and the slow grind of justice vs. crisis response.

## 9. District: Gemini (Janbogo Subnet Nexus) – Information / Communication
##### Enneagram:
* Major Theme: Thinking — Core focus on data flow, verification, rumors vs. truth, and intellectual exchange.
* Hornevian Group: Withdrawn (with Assertive streaks) — Deep focus on information gathering and analysis, but also bold dissemination or gatekeeping.
* Harmonic Group: Competency — Emphasis on accuracy, speed vs. verification, and objective handling of information.
##### Reasoning:
...
* Harmonic Group: Reactive — Intense emotional negotiations, quick retaliations, and raw survival responses.
##### Reasoning:
...
* Harmonic Group: Positive Outlook — Optimistic idealism and reframing harsh conditions as adventure or philosophical growth.
##### Reasoning:
* The windswept frontier of expansion, watchtowers, and exploratory outposts is ideal for Assertive + Instinctive + Positive Outlook groups. Rich RP opportunities arise in debates about expansion vs. consolidation, frontier idealism vs. brutal reality, and the thrill of discovery vs. the cost of isolation. Positive Outlook fits the philosophical debate halls and hopeful settler spirit even amid scarcity.

## 12. District: Virgo (Concordia Undergrid) – Maintenance / Service
##### Enneagram:
* Major Theme: Thinking (with Instinctive elements) — Systematic problem-solving, perfectionism, and hidden infrastructure realities.
* Hornevian Group: Compliant — Dutiful service to the entire city, long-term reliability, and quiet sacrifice.
* Harmonic Group: Competency — Focus on doing repairs “right,” efficiency vs. perfection, and objective maintenance.
##### Reasoning:
...
* Core Focus: Cancer emphasizes protection and integration of the vulnerable (refugees, orphans, the grieving, defectors). Taurus emphasizes preservation and routine of established bonded pairs and community stability.
* Quest/Story Potential: Cancer quests involve emotional triage, refugee integration crises, psychological care ethics, and sheltering vs. resource hoarding. Taurus quests center on domestic disputes (luxury vs. newcomers), maintaining quiet family life vs. cultural events, and long-term home upgrades vs. immediate survival stockpiling.
##### B. Direct Conflicts
* Resource Competition: Both heavily rely on hydroponics, heat, and living space. Cancer’s refugee influx and protective programs strain Taurus’ cozy stability and food/heat priorities.
...
* Core Focus: Aries is about controlled high-output survival and power allocation for the whole city. Pisces is about fluid, opportunistic gray-market flow of forbidden goods and services.
* Quest/Story Potential: Aries involves overclocking risks, blackouts, worker heroism vs. equality, and aggressive expansion of power. Pisces involves smuggling ethics (compassionate vs. pure profit), vice regulation, and navigating dangerous alliances in the shadows.
##### B. Direct Conflicts
* Power & Resources: Aries controls the literal lifeblood (heat/power). Pisces operations (illegal distilleries, augmentation clinics, memory editing) depend on diverted or stolen power/siligel. Blackouts or restrictions from Aries directly cripple Pisces trade.
...
* Core Focus: Aquarius centers on physical/technological breakthroughs and ethical boundaries of innovation. Gemini centers on information flow, verification, and the battle between free data and harmful rumors.
* Quest/Story Potential: Aquarius involves human vs. robot experimentation ethics, open-source vs. proprietary tech, and visionary long-term goals. Gemini involves data archaeology, rumor control vs. transparency, and entertainment vs. vital survival alerts.
##### B. Direct Conflicts
* Data & Experiments: Aquarius experiments generate massive data (and potential leaks/trauma). Gemini manages the networks that process and distribute that data — creating tension over who controls sensitive research outputs.
...
* Core Focus: Libra is about high-level balance, justice, and centralized planning. Virgo is about ground-level maintenance, reliability, and hidden infrastructure service.
* Quest/Story Potential: Libra involves resource allocation politics, transparency vs. secrecy, and district autonomy vs. central control. Virgo involves perfectionist repairs vs. quick fixes, equal service vs. prioritization, and long-term infrastructure vs. emergency patches.
##### B. Direct Conflicts
* Bureaucracy vs. Reality: Libra’s slow, rule-heavy decisions directly impact Virgo’s ability to maintain systems (e.g., delayed resources for repairs). Virgo’s “failures” are often blamed on surface districts or central policy.
* Storylines: Players could run quests mediating between Libra’s resource allocation bureaucracy and Virgo’s on-the-ground maintenance crises, or investigate corruption where central decisions favor certain districts at the expense of infrastructure. Virgo tunnels could be used for smuggling (clashing with Libra crackdowns) or hide secrets that undermine official narratives.
* Player Agency & Ripples: Over-centralizing Libra power might leave Virgo under-resourced, causing widespread failures and blame. Empowering Virgo’s practical fixes could undermine Libra’s authority or reveal inconvenient truths. Long-term ripples include separatist sentiment, infrastructure collapse, or district-wide resentment against “uncaring” central bureaucracy.
