...
* Warm, humid, softly lit multi-level domes with thick insulation. Gentle curving architecture, lots of soft greens and blues, constant gentle airflow and water sounds.
## What you’d find here: 
* Large family habitation clusters and creches
* Advanced but gentle medical/psychological care centers
* Hydroponic healing gardens and therapy parks
* Orphanages and integration centers for new robots and refugees
* Bonding ceremony halls and grief support circles
* Emergency shelters optimized for cold-shock recovery
...
## Setting Setting & Environs: Environs:
* Multi-ringed, heavily insulated residential domes with warm lighting, private courtyards, and a stubborn coziness.
## What you’d find here:
* Layered habitation rings with family units
* Private and communal hydroponic gardens
* Community heating distribution centers
* Schools, creches, and recreation halls
* Memorial walls for lost bonded partners
* Small markets focused on domestic goods and comfort items
...
## Setting Setting & Environs: Environs:
* Bright, dramatic, golden and neon-lit open plazas with stunning acoustics and grand architecture.
## What you’d find here:
* The Grand Amphitheater and multiple smaller performance venues
* The Golden Ring promenade (buskers, poets, street performers)
* Sonic art installations and vibrating public sculptures
* Artist ateliers and resonance workshops
* The Eternal Festival Grounds (rotating cultural events)
* Upscale (and black-market) entertainment venues
...
## Setting Setting & Environs: Environs:
* Dim, intense crimson and violet lighting, steam-filled chambers, heavy and introspective atmosphere.
## What you’d find here:
* Rebirth clinics and extreme therapy centers
* The Archive of Final Confessions
* Ritual endurance arenas and meditation chambers
* Shadow augmentation parlors
* Near-death simulation facilities
* Private grief sanctums and transformation temples
...
* Overclock monitoring stations
* Raw energy conversion foundries
...
## Setting Setting & Environs: Environs:
* Brutalist, impressive, noisy metal and concrete structures with glowing forges and strict order.
## What you’d find here:
* Massive robot manufacturing foundries
* Central siligel refinement and quality-control complexes
* Heavy infrastructure construction yards
...
## Setting Setting & Environs: Environs:
* Clean, futuristic white and blue labs with prototype robots, humming test chambers, and an air of controlled chaos.
## What you’d find here:
* Advanced Robotics Institute
* Experimental siligel and hybrid tech labs
* Cold-resistance and human/robot enhancement chambers
* University of Concordia (Arcanet studies)
* Prototype testing grounds
* Ethical review boards and debate halls
...
## Setting Setting & Environs: Environs:
* Elegant, austere spire with polished metal, glass, and formal holographic seals.
## What you’d find here:
* Concordia Governing Council Chambers
* Treaty Archive Vaults
* Bureau of Resource Allocation
* Diplomatic reception halls
* Justice and arbitration courts
* Public policy announcement plazas
...
## Orientation:
* The nervous system and information hub of the city.
## Setting Setting & Environs: Environs:
* Bright, ever-changing, full of holographic displays, data streams, and constant movement.
## What you’d find here:
* The main Arcanet routing towers
* Public news and information forums
* Data archaeology and recovery labs
* Communication relay stations
* Rumor exchanges and gossip halls
* Secure private channel suites
...
## Setting Setting & Environs: Environs:
* Dim, hazy, neon-reflected puddles, whispered deals in hidden alcoves.
## What you’d find here:
* The Shadow Exchange trading floor
* Illegal siligel distilleries and power cell smugglers
* Underground augmentation clinics
* Memory editing dens and virtual escape pods
* Information brokers and blackmail archives
* Contraband Arcanet nodes
...
## Setting Setting & Environs: Environs:
* Harsh, windswept, partially completed domes overlooking endless snow and ice.
## What you’d find here:
...
## Setting Setting & Environs: Environs:
* Dark, labyrinthine tunnels with dripping condensation, glowing maintenance lights, and constant mechanical hum.
## What you’d find here:
* Primary utility tunnels and repair hubs
* Backup Arcanet and power routing nodes
* Maintenance crew barracks and workshops
* Waste reclamation and recycling centers
* Hidden emergency supply caches
* Forgotten pre-war research annexes
...
## Orientation:
* The crossroads and administrative heart where all districts meet.
## Setting Setting & Environs: Environs:
...
* Major market concourse
* The Bridge Memorial (honoring those who left via Amundsen Tower)
