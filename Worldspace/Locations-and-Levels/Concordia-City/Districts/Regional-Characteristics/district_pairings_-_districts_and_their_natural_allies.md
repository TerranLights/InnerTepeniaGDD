...
### 1. Cancer (TBN-district) – Nurturing / ProtectiveNatural Allies:
* Taurus (TBN-district) — Primary ally. Both are deeply emotional/residential and focused on bonded life, family stability, and protecting the vulnerable. Cancer’s protective services directly enable Taurus’ cozy domestic stability.
* Libra (TBN-district) — Secondary ally. Cancer’s work with refugees, defectors, and the vulnerable benefits from Libra’s diplomatic and policy-level protection.
...
### 2. Taurus (TBN-district) – Residential / StabilityNatural Allies:
* Cancer (TBN-district) — Primary ally (mutual as above).
...
### 5. Aries (TBN-district) – Raw Survival / EnergyNatural Allies:
* Capricorn (TBN-district) — Primary. Industry runs on power. Aries’ energy production directly fuels Capricorn’s manufacturing, forges, and heavy infrastructure.
...
### 6. Capricorn (TBN-district) – Industrial / AmbitionNatural Allies:
* Aries (TBN-district) — Primary (mutual as above).
...
### 8. Libra (TBN-district) – Diplomatic / BalanceNatural Allies:
...
* Cancer (TBN-district) — Strong secondary. Protective humanitarian policies require diplomatic backing and resource allocation at the central level.
### Why they work well together:
...
* Libra (TBN-district) — Primary (mutual as above).
* Aries (TBN-district) and/or Capricorn (TBN-district) — Strong practical allies. Heavy industrial and power systems require constant, high-quality maintenance.
### Why they work well together:
