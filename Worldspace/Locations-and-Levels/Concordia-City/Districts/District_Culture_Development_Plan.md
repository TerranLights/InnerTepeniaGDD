...
> **⚠ MANDATORY: read `Phase_Instructions/00_RUNBOOK.md` in full before any work on this Plan or on any
> district's culture.** Binding per the project `CLAUDE.md`. This file is the *what*
...
- **Why rewritten:** the first pass re-labeled existing canon rather than generating new culture, and "applied" the Real-World Basis method from memory instead of researching. Redone with actual research on all eight picks; **four had never been used at all** (Père Lachaise, Arcosanti, Findhorn, Hundertwasserhaus) and three of those four produced the file's strongest material. **This is the reference example for the other 12 districts** — see `Real-World_Basis_Extrapolation_Method.md`'s worked-example table.
...
### 06 — Capricorn (The Yards) — **ALL 8 PHASES COMPLETE + QA PASSED (2026-08-29)** — *third Mode B district*

> **Gate 0: PASS.** Claim and file agreed. **The Narrow Door remains unresolved by design** — Finding III
> reserves the choice among the six alternative conditions for the developer, and every finding in this pass is
> compatible with all six. The single most damning artifact the substrate offers (the apprentice's handbook) is
> recorded in Gate 7 as available and **deliberately withheld**, because writing it would decide the question.

- Architecture — **Done 2026-08-29** (Finding V — the perimeter as civic virtue; no space built for idleness)
- Sensory Profile — **Done 2026-08-29** (Finding VI)
- Export Culture — **Done 2026-08-29** (Finding VII — structure, organizers, and standards given away free)
- Religious/Philosophical Landscape — **Done 2026-08-29, provisional per the Plan's own instruction** (Finding VIII — names the creed *standing is paid for* without touching the Door)
- Fashion — **Done 2026-08-29** (Finding IX — grade-marks; the limp as service record)
- Arcanet Culture (dedicated) — **Done 2026-08-29** (Finding X — documentary; the favor ledger running in parallel)
- Visitor Experience / Visitor-to-Resident Transition — **Done 2026-08-29** (Finding XI — test-and-admit, the thirty-year threshold; conflict geometry written in per Mode B)
- Ordinary Daily Life — **Done 2026-08-29** (Finding XII, Phase 5 — the inverted age curve; humor as load-bearing)
- Thematic Breadth Catalog — **Done 2026-08-29** (Finding XIII, Phase 6 — the Two Founders)
- Native Culture — **Done 2026-08-29** (Findings XIV-XVI, Phase 7 — *a guild with the burial fund and the patron's day missing*)
- Robot-Specific Culture — **Done 2026-08-29** (Finding XVII, Phase 8 — first-pass)
- Substrate findings — **Done 2026-08-29** (Findings XVIII-XX)
- **Review Panel — Findings XXI-XXII.** First run on the archetype roster; produced the first `refereed` disposition.
- **QA Completion Check — PASSED 2026-08-29**, Gates 0-10. Gate 9 failed and produced Finding XIX (**fifth consecutive district, again in pre-Plan material**). `sport`, `slang`, `gender` open; `death` addressed as an absence.
- **First district with one *addressed* and one *diffuse* structural deficit** — it knows it has a care problem and does not know it has a meaning problem.
...
### 07 — Aquarius (The Labs) — **ALL 8 PHASES COMPLETE + QA PASSED (2026-08-29)** — *fourth Mode B district*

> **Gate 0: PASS**, in a third distinct state — the Plan honestly marked Architecture and Sensory Profile
> "+ (has it)", which pre-Plan Findings I-III cover. Claim matched file.
> **First district run under LAW 0.** The pass initially stopped at two of nine researched picks; the law was
> added mid-pass and four more were then researched. **The two strongest findings (XVII, XVIII) came from
> picks four, five and six and did not exist before that.**

- Architecture / Sensory Profile — **pre-existing** (Findings I-III, left standing)
- Export Culture — **Done 2026-08-29** (Finding V — findings given away; method as the real export; the Outfacing Office)
- Religious/Philosophical Landscape — **Done 2026-08-29** (Finding VI — the consent doctrine pointed inward only; *a truth belongs to everyone*)
- Fashion — **Done 2026-08-29** (Finding VII — cheap singular pieces; strangeness as an earned rank marker)
- Arcanet Culture (dedicated) — **Done 2026-08-29** (Finding VIII — an archive of what worked; failures never written)
- Visitor Experience / Transition — **Done 2026-08-29** (Finding IX — conversion, not admission; conflict geometry written in)
- Ordinary Daily Life — **Done 2026-08-29** (Finding X — minimum supervision as policy)
- Thematic Breadth Catalog — **Done 2026-08-29** (Finding XI — the Layer, the Outfacing Office, the Underflow)
- Native Culture — **Done 2026-08-29** (Findings XII-XIV, Phase 7 — the open corpus; **no counterculture, and that is the finding**)
- Robot-Specific Culture — **Done 2026-08-29** (Finding XV, Phase 8 — first-pass)
- Substrate findings — **Done 2026-08-29** (Findings XVI-XVIII)
- **Review Panel — Finding XIX.** Second run on the archetype roster; two `unmet` dispositions.
...
- **ALL PHASES COMPLETE and QA-PASSED 2026-08-29**, Gates 0-10, sixth Mode B district. `Gemini_Full_Extrapolation.md` Findings VI-XXV. **Gate 0 PASSED — the first accurate Plan claim in the districts checked** (one borderline: Sensory should have been marked *promote*, not *needed*). Gate 9 fired → Finding VIII (**eighth consecutive district, again in the pre-Plan material**). **Third district on the two-term capability shape**, and the consequence is unrelated to Leo's and the Labs'. **Research: 10 items, 8 changed findings, 2 ornamented only** — one deliberately withheld because it would have scoped the reserved Lightwave Polyrhythm. **The Death and the Dead category was written into the pass rather than back-filled** — the first district where that happened.
...
- Thematic Breadth Catalog — needed (Phase 6)
- Robot-Specific Culture — needed (Phase 8)
- **ALL PHASES COMPLETE and QA-PASSED 2026-08-29**, Gates 0-10, eighth Mode B district. `Sagittarius_Full_Extrapolation.md` Findings VII-XXXI. **Fourth district on the two-term shape and the first written directly after its own opposition** — Finding VII carries a mandatory non-symmetry table against the Circuit. Gate 0 passed on **both** halves. Gate 9 fired inherited (Finding IX) and **on the pass's own material, caught by the developer** — the counterculture was first written as social exclusion, which scaled an individual-psychology source line into a civic sanction and ignored that outside is lethal here; corrected, rule recorded in `00d`. **Research: 9 items, 7 changed findings, 1 ornamented, 1 named omission (Timbuktu).** **Finding XXX is a reserved handoff to the Hub** — the Sagittarius substrate holds the corpus's only Ophiuchus chapter.
...
- Thematic Breadth Catalog — needed (Phase 6)
- Robot-Specific Culture — needed (Phase 8)
- **ALL PHASES COMPLETE and QA-PASSED 2026-08-29**, Gates 0-**11**, ninth Mode B district and **the first pass run with Gate 11**. `Virgo_Full_Extrapolation.md` Findings VII-XXXII. **Second *doubled row*, written under the pairing rule** — the Markets' file was read in full before Step 2 and Finding VII answers from this side without inverting theirs. Gate 0 passed both halves. Gate 9 fired inherited (IX) **and on the pass's own material** (XXI). **Gate 11 flagged a real over-write before it shipped** — an exclusion written harder than the district would pay for, the Frostlands' error caught one district later. **Research: 8 items, 6 changed findings, 1 ornamented, 1 named omission (merchant navy engine rooms).** **Finding XXXI is a reserved note on the Deep Level** — the one thing this district does not document.
