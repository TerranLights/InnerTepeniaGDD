...
- `Outside-World/.../City_Megasheets/City_Megasheet_Compilation_Guide.md` — the master synthesize → invent →
  ...
  phase content continues to follow.
- `../00b_Two_Stage_Methodology.md` — Stage 1 (organic pre-war formation) vs. Stage 2 (war fallout) as separate
  causal layers.
- `../District_History_Enhancement_Opportunities_Template.md` — the reusable 5-lens ideation structure.

Each phase file below assumes you've read the Plan file's own entry for that phase first, then goes far deeper
