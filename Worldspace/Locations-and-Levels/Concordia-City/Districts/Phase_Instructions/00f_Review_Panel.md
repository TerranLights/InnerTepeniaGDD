...
| Archetype | Cast for a Concordia district as | The question, in costume |
|---|---|---|
...
- **Aries's panel run (2026-08-29) predates this roster.** It was run against the earlier invented list of
  fifteen social positions. **Its findings stand** — they were real objections, written up as Findings XXI-XXIII
  — but it is **not** a demonstration of this roster, and the run should be repeated against the archetypes when
