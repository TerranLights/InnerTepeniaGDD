...
- **a. Primary language(s):** French and Italian as the founding-institutional languages — administrative records, the oldest street and district names, ceremonial usage — but by 2812, Mandarin, Japanese, Korean, Russian, Indonesian, and Australian-inflected English are the languages most of the population actually lived in day to day, per Section 1. Unlike Sayowa, where the founding Japanese character stays genuinely dominant, Concordia's founding languages became a minority administrative register within their own city.
