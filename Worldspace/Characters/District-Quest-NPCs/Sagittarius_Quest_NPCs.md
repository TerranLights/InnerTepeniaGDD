...
**Species:** Human
**Age:** Early 40s
**Origin:** Capricorn; moved to Sagittarius fifteen years ago

**Personality:**
Specific, technical, not dramatic about it. Has the engineer's fundamental relationship with data: it says what it says. Is not trying to stop the expedition — she has been explicit about this multiple times and will continue to be explicit about it because the conflation of "slow down" with "stop" has produced the specific confusion that is making this situation more dangerous. She is frustrated by the conflation in a way she keeps contained.

She is not pessimistic. She is not risk-averse beyond what the structural data supports. She has approved expeditions before with equivalent or greater apparent risk when the data justified it. This one doesn't justify it, and "the data says three weeks of route reinforcement" is not the same as "don't go."

**Backstory:**
Came from Capricorn to Sagittarius specifically because the structural engineering problems in the Frostlands are more interesting than anything in Capricorn — the variable permafrost, the expansion and contraction cycles, the way pre-war construction handles conditions the pre-war engineers understood differently. Has been doing structural analysis in Sagittarius for fifteen years. Was brought in after the Siligel Rush and Bust to do post-boom structural assessment and has remained. Has been watching Sagittarius make the same structural mistake in different forms — the cultural bias toward expansion over consolidation, expressed in engineering terms — since she arrived. Not bitter about it. Genuinely interested in the pattern.

**Temperament:**
Patient up to a specific threshold, then blunt. The bluntness is not aggression — it is the professional obligation to be clear about what the data says when the consequence of ambiguity is a person dying. Does not confuse being liked with being effective.

**Daily habits:**
Field surveys in the morning, analysis in the afternoon. The field surveys are not incidental — she needs direct sensory data rather than relying entirely on instrumentation, because fifteen years in the Frostlands have given her a visual and tactile knowledge of structural conditions that instruments measure imprecisely. The analysis translates the field knowledge into terms that can be shared.

**Living conditions:**
A working apartment rather than a home — organized entirely around the work. Maps on every available surface; the maps are working documents, annotated, updated, layered with Frostlands data accumulated over fifteen years. A functional kitchen. The kitchen gets used.
...
She is also funny. This surprises people who come to her for solemnity. The humor is specific and earned and lives in the same register as everything else she knows.

**Backstory:**
Was twenty-three on the Third Expansion Collapse rescue team. Spent eleven days at the site. Came back changed in a way that took years to fully understand — not traumatized exactly, but reconfigured. The reconfiguration directed her entire subsequent life into the Memory Keeper practice: the oral tradition, the sustained transmission of experiential knowledge, the specific effort to preserve not what happened but what it was like. Has been doing this for fifty years.

The Collapse story is one of her primary transmissions — she has told it hundreds of times, in the specific form that preserves its essential character across the telling. She has refined the telling across fifty years. She knows exactly which elements land and which elements need to be preceded by which other elements. The expedition lead hearing it directly, person to person, is a form of transmission she has been waiting for without knowing quite when it would arrive.

**Temperament:**
Unhurried, specific, capable of holding both the weight and the humor of a thing simultaneously. Has the particular authority of someone who has lived long enough to know what they know — which includes knowing that they know something and that the knowledge is true even when it is inconvenient for people who would prefer it to be different.

**Daily habits:**
Storytelling sessions in the evening with whoever comes. One-on-one conversations during the day with whoever needs the long version. Walks the same route through the Sagittarius Frostlands district every morning — not for exercise but as a practice of inhabiting the oral tradition of the space: this is where this happened, this is the place that relates to that story, the district as a mnemonic structure.

**Living conditions:**
A storytelling space that is also a living space. Warm, full, accumulated over fifty years of people coming and going and leaving things. The space reads as a repository of Sagittarius' oral tradition in material form: objects with specific stories attached to them, arranged in a way that is not decorative but functional — each one a memory trigger, a thread of the transmission web.
