...
That file is the general-purpose methodology for producing psychological depth in any Doll character; this file
...
- **"Bad Ass" as a cross-role umbrella term** (Introduction) — the book's own organizing move: a "bad ass" isn't
  ...
  minor/supporting character. Useful as a reminder when starting any morally complex Doll: decide which *role*
...
- **Twelve named Anti-Hero roles**, a taxonomy parallel to (and cleanly non-overlapping with) Weiland's twelve
  ...
  **Dark Hero / Byronic Hero** (angst-ridden, attractive, brooding loner — the direct ancestor of the modern
  ...
  a movement). Directly usable as a classification pass for existing morally-complex Dolls, and as a generative
...
### Turnus (Ch. 1, Penny Eley)

- **Implicit Contrast via Selective Omission** — the Old French adaptor never calls Turnus treacherous outright; instead he strips out, one by one, the positive epithets, physical portraits, and troop-admiration scenes Virgil gave him, then hands those same virtues (beauty, wisdom, governance skill) to adjacent characters (Camille, Drances) fighting the same war. Turnus's badness registers entirely as an absence made visible by contrast, never as an authorial assertion. Distinct from Mordred's "layered incremental sympathy" (which accretes sympathy over time): this runs the same accretion process in reverse — condemn a character by quietly withholding, scene by scene, the flattering narration a "good" character in the same role would automatically receive, rather than ever stating outright that she's the villain.
- **Self-Serving Misrepresentation Under Dramatic Irony** — Turnus reports his own grievance to his allies in a speech the audience already knows to be false (they saw him seize the land before ever petitioning the king; he claims to have sought redress "at length" when he never asked at all). His allies believe him; the audience doesn't. Reusable device for establishing an antagonist's unreliability without an omniscient narrator ever calling her a liar: stage the true events first, then let her recount a self-flattering version to a second in-fiction audience, so the player's own memory does the indicting.
- **Puppet-of-Ambition Dynamic** — Turnus's fatal flaw isn't personal cruelty but subservience: he takes his marching orders from a queen with her own agenda rather than from his own counsel or sworn vassals, and his "loyalty" to her scheme (not to any conviction of his own) is what damns him as unfit to rule. Useful for a villain/rival companion whose culpability comes from *whose direction she took*, not from any atrocity she personally conceived — a co-opted instrument of someone else's ambition, undone by never asking whose interests she was actually serving.
- **Procedural-Legitimacy Erosion** — Turnus's underlying grievance (a broken marriage promise) is objectively real, but he forfeits all moral standing by seizing the land unilaterally before any court hears his case, converting a legitimate complaint into a naked power grab. A clean design knob distinct from whether a grievance is *true*: a companion or rival can be right about the wrong done to her and still lose the player's sympathy entirely based on how she pursues it — skipping legitimate recourse costs her more credibility than the original injury cost her opponent.
- **Symbol-Tied Vice as Foreshadowing** — of Virgil's dozens of epic similes, the adaptor keeps exactly one for Turnus: a hungry wolf circling a sheepfold, chosen because medieval bestiary tradition already coded wolves as the emblem of greed specifically (not predation generally) — and the same image is later inverted to foreshadow his death ("the wolf risks losing its skin"). A tight, reusable technique: pick one animal/object symbol whose *specific* connotation matches a villain's defining vice exactly, attach it once early, and let the same image recur at her downfall so the ending reads as the symbol completing itself rather than a new idea introduced late.
- **When Mercy Must Be Refused** — the poet builds the whole account so that Aeneas's refusal to spare a surrendering Turnus reads as fully earned rather than as the hero's own cruelty: only once a villain's every avenue for legitimate sympathy has been closed off (procedural bad faith, greed-coded motives, no genuine love, a betrayal to avenge) does a "no-mercy" climax become satisfying rather than uncomfortable. Useful as a checklist before writing a companion questline's final unmerciful confrontation: has the narrative actually closed every one of the antagonist's redemption exits first, or is the "deserved" ending being asserted rather than earned?

### Alexander the Great (Ch. 2, David Ashurst)

- **The Split Judgement, Held Simultaneously Not Sequentially** — Walter of Châtillon condemns Alexander as an insatiable madman and, fourteen lines later, decries Fortune and the gods for allowing such greatness to fall, without ever reconciling the two. Distinct from Mordred's "layered incremental sympathy" (which accretes sympathy gradually over narrative time) and from the Introduction's "character-assassinated-or-rehabilitated figure" (different tellings, different verdicts): this is two complete, incompatible verdicts asserted by the *same* narrator in the *same* breath, neither one hedged or subordinated to the other. Usable for a single eulogy, obituary, or in-fiction historical account of a fallen antagonist/companion that refuses to resolve into one clean verdict, forcing the player to hold both readings at once rather than being handed a synthesis.
- **One Trait, Two Valences by Authorial Lens Alone** — Alexander's insatiability reads as either contemptible greed or admirable, unbreakable resolve depending purely on which chronicler is narrating it, with zero change to the underlying facts or actions. Worth using as a design-test: take a companion or antagonist's single defining trait and write two short in-fiction "takes" on it (a hostile record and an admiring one) to see how much genuine flexibility the character's sympathy actually has before any of her actions change.
- **The Reusable Reconciliation Beat: Sincere vs. Ironic Staging** — the identical plot beat (a victor weeps over and comforts a dying, defeated rival, offering to restore his kingdom) is staged by different authors either as sincere, pathos-deepening chivalry or as pointed irony exposing hypocrisy (one text has the victor dry his tears on the dead man's own looted imperial cloth). The blocking is identical; only the directorial choice changes the reading. Useful direction note for a companion's or rival's death/reconciliation scene: decide deliberately whether the same gesture is meant to read as genuine grief or as a quiet indictment, since the staging alone can't settle it.
- **Full-Weight Two-Horned Dilemma as an Ending** — Walter's closing move constructs two complete, textually-supported interpretations of Alexander's final, most transgressive act (his heroic virtues curdled into vice, *or* his virtues persisted intact but are now serving a mistaken though sincere faith) and pointedly declines to resolve which is true, leaving the choice to depend on what the reader already believes about the world. Distinct from ordinary "moral ambiguity": both readings are fully worked out and textually grounded, not one confident reading with a token acknowledgment of doubt. Reusable for an antagonist's or companion's final, most damning act: write out two complete, equally well-supported interpretations rather than one dominant reading with a hedge.

### Hengist (Ch. 3, Margaret Lamont)

*(This chapter's argument is built almost entirely from real-world English/Norman/Welsh ethnic and national identity, plus an explicit modern-Mexican-mestizaje comparison — exactly the material [[feedback_no_national_stereotypes|the No National Stereotypes law]] keeps off-limits. The three techniques below are abstracted well clear of that specific content and should be built only from Tepenia's own invented founding figures and city-founding legends, never mapped onto any real people, nation, or ethnicity.)*

- **The Ancestor-Enemy Hybrid Position** — even in the earliest, most hostile portrayal of Hengist, he retains one positive marker (noble bearing, handsome looks) that is never fully stripped away, becoming the "germ" every later, more sympathetic retelling expands from. Generalizable mechanic: a character who functions as antagonist to one in-fiction faction but ancestor/founder to another can be written as a full villain by the hosting narrator while still leaving one small, undeniably positive trait planted and untouched — a reserve of sympathy a later work (a DLC, a companion's own retelling of her family's founder) can expand into fuller rehabilitation without contradicting anything the original telling said.
- **The Loyalty-Within-Betrayal Exception** — Wace's Hengist orchestrates a mass-casualty ambush of his own hosts, then personally stops his men from killing one specific man (his son-in-law) for one clearly stated personal reason ("he has done much for me"). The scale and body count of the betrayal is completely unchanged; the single carved-out exception is what shifts the whole character from villain to anti-hero in the audience's eyes. Distinct from Morrell's Intimacy Technique or Cartlidge's own "Understand, Not Forgive" (both about explaining motive after the fact): this is live demonstrated behavior *during* the atrocity itself — give a mass-betraying antagonist exactly one specific, named person she still protects mid-betrayal, for a stated personal reason, leaving the rest of the massacre's scale completely untouched.
- **Plot-Shape and Moral-Coloring as Independent Levers** — the same invasion pattern (a people arrives, is twice repelled, finally triumphs only because a local ruler's bad governance or an internal betrayal hands them the win) recurs for two entirely different invading factions in the same text, with opposite emotional coloring attached to each — one becomes cousin/rival treated with real ambivalence, the other becomes an irredeemable villain — despite no difference in the actual plot beats. Worth keeping as an explicit design reminder: the sympathetic-or-hostile "coloring" given to a faction (which epithets survive, whether an internal betrayal is dwelt on or glossed over, whether reconciliation and intermarriage follow) is a fully separate authorial choice from the underlying mechanics of how a conquest or coup actually unfolds — the same invasion skeleton can be dressed as tragedy or triumph purely through narration.

### Harold Godwineson (Ch. 4, Laura Ashe)

- **Legal Erasure as Damnatio Memoriae, Distinct from Narrative Villain-Coding** — rather than a villain arc, Domesday Book simply erases Harold's reign from the official record, dating all pre-Conquest landholding to "the time of King Edward" and recording Harold throughout only as an earl who was never truly king. Portable as a non-narrative device: an in-fiction bureaucratic or archival record (a city's census, a corporate personnel file, a district's official history) can delegitimize a contested figure's tenure or claim purely through what it omits or how it labels her, without any story beat ever condemning her directly — damnatio memoriae by paperwork rather than by plot.
- **Redirecting Systemic Blame to Preserve Individual Sympathy Under a Providential Cosmology** — writers who wanted to praise Harold but worked within a worldview where defeat *must* reflect divine judgment on moral failing solved the problem by relocating the guilt: not "Harold deserved to lose" but "God's vengeance was owed to the whole nation for its own sins," or "one specific, narrow fault (a broken oath) sufficed," leaving Harold's broader character untouched. Directly useful for a setting with any implicit consequence-cosmology (a game where narrative defeat reads as "the world's" judgment): when a sympathetic character must still lose, give the audience a specific, narrow, technical fault to pin the defeat on, or spread the blame across a wider collective, rather than letting the loss read as an indictment of her whole nature.
- **Invented Betrayal-From-Within to Preserve Both Competence and Moral Standing in a Necessary Defeat** — an English legendary account blames Harold's loss at Hastings on treachery among his own nobles, which the chapter notes is "quite possibly a literary invention... which preserves the moral integrity of the fallen hero." Distinct from Turnus's Puppet-of-Ambition Dynamic (which damns the puppet) and from the Regional-Reputation Shorthand already flagged for caution (Mordred, Ch. 5): this device runs in the opposite direction, protecting the loser. When a hero or companion must suffer a canonical defeat but needs to stay narratively competent and trustworthy afterward, attribute the loss to an invented or minimized betrayal from her own side rather than to the external opponent's superiority or to any error of hers.
- **Marginality Reframed as Victory, Not Reversed** — the single richest find in this chapter. The *Vita Haroldi* does not rewrite or undo Harold's political defeat; instead it reframes his forced statelessness — losing the kingdom, losing his name, becoming steadily "less and less himself" — as the character's own quiet, uncontested triumph, citing scripture that attachment to homeland is spiritual weakness and detachment from it is the more perfect state. The text explicitly stresses "the surprising lack of any real change" in Harold's underlying nature — only the frame around it shifts, and his political loss stands completely unreversed even as it is recast as the truer win. A genuinely distinct arc-shape from anything else in this file: instead of forcing a late-game reversal or redemption for a companion whose story ends in political or military failure, let the failure stand entirely, and give her an unambiguous victory in a different, largely uncontested register (found identity, chosen exile, an inner peace no external power can revoke) that the "winning" side has no interest in disputing because it was never playing that game.
- **The Liminality Payoff: Erasure Creates Room for Competing Unofficial Legends** — because the dominant historiography wrote Harold out, he became a blank that marginalized communities (the Welsh borderlands, Chester, the Anglo-Danish world) were free to claim and elaborate on their own terms, producing an entire separate legendary tradition (survival myths, hermit legends, cultic veneration) precisely because no single authority controlled his story anymore. Useful worldbuilding principle distinct from the earlier point about official erasure: a companion or Notable Figure whose canonical story has been suppressed or overwritten by a dominant power becomes structurally free territory for marginalized in-fiction communities to build their own competing, unofficial legends around her — different subcultures within Tepenia could maintain wildly different, mutually unaware unofficial accounts of a suppressed figure's fate, none of them official, all of them meaningful to whoever tells them.

### Merlin (Ch. 6, Gareth Griffith)

*(Merlin also appears within the already-mined Sons of Devils chapter, as Antichrist's demonic-half-brother and the source of the "Two Valid Modes of Living With a Monstrous Origin" bullet already captured there — his untroubled, crisis-free acceptance of his own demonic ancestry, contrasted with Robert le Diable and Gowther's traumatic reckoning. The material below is new, drawn from Merlin's own dedicated chapter rather than his cameo in Cartlidge's chapter.)*

- **The Split-Origin Power Allocation (Dual-Source Gift Mechanic)** — Robert de Boron's solution to writing a demon-born character who isn't presumptively evil is mechanical, not just thematic: Merlin's prophetic gift is explicitly built from two separately sourced halves — knowledge of the past inherited from his demon father, knowledge of the future granted directly by God — with the text stressing that Merlin retains an ongoing, live choice of which source to answer to. This is a sturdier device than a "nature vs. nurture" metaphor: it's two distinct power-sources coexisting in one kit. Directly portable for a Doll or companion with a morally split origin (built partly under a legitimate program, partly under a forbidden one): split her actual ability kit into two sourced halves tied to the two origins, and make leaning on one or the other a legible, player-visible choice across her questline, rather than leaving "which side she takes after" as background lore only.
- **Detached Omniscience Signaled Through Unresolved Reactions, Not Exposition** — Merlin twice laughs, unexplained and unironized by the narrator, at deaths and hidden adulteries only he perceives; the text pointedly supplies no memento-mori framing or narratorial judgment to settle whether this is wisdom transcending mortal concern or genuine callousness. Useful device for an all-knowing or oracle-type companion: use small, unglossed reactions to tragedy (not dialogue explaining her worldview) to signal that her knowledge has cost her something recognizably human, and deliberately leave the audience without an authorial verdict on whether that cost is wisdom or damage.
- **The Vow-Then-Complication Rhythm** — every one of Merlin's explicit renunciations of his demonic heritage ("the Enemy have lost me...") is immediately hedged ("God willing") or shortly followed by an action that quietly undercuts it (enabling Uther's deception of Igerne right after his own mother's near-identical violation has been condemned at length). This is a sustained structural rhythm, not a single hypocrisy reveal: pair a character's periodic, sincere-sounding self-declarations of reformed intent with a near-immediate action that complicates them, repeated throughout her arc, so the audience is never allowed to fully relax into trusting her stated intentions even while she keeps sounding trustworthy.
- **The Safe-Distance Prophet as a Political-Commentary Device** — putting prophecy in the mouth of a long-dead legendary figure let medieval writers comment on live contemporary politics without personally bearing the risk of a living claimant to divine knowledge challenging Church or Crown; the prophet's safe remove in the deep past is what makes the commentary usable at all. Reusable worldbuilding device: a Notable Figure who is already dead, legendary, or otherwise safely out of reach (a recovered prophecy, an old AI's archived broadcast, a founder's testament) can be quoted by the living cast to deliver pointed commentary on a current city's or faction's politics without any living character having to visibly take the dangerous political stance herself.
- **Overpowered-Ally Removal as a Craft Problem, Solved with Deliberately Porous Devices** — the chapter's central structural point: an all-knowing or all-powerful ally is a narrative-design problem distinct from a moral one, since perfect foreknowledge or invulnerability removes the tension a story needs. Every version of the Merlin legend therefore invents some device to take him off the board (fading from the text, magical imprisonment, self-imposed withdrawal until the apocalypse) — but notably, none of these removals are airtight; each leaves an escape hatch (still quoted as legend, visited in prison, referenced retrospectively as having acted off-page, promised to return). Direct craft note for any companion with reality-warping or plot-solving-by-fiat capabilities (a hacker-type Doll, an oracle AI): decide up front which specific device sidelines her during the sections where her power would flatten the challenge, and consider leaving that removal deliberately incomplete or porous — dormant, imprisoned, or absent rather than truly gone — so she remains a living presence in the story's texture even while mechanically off the board.

### Gawain (Ch. 7, Kate McClune)

*(This chapter also documents a sharp Scots-vs-English divergence in how favorably Gawain is portrayed, tied directly to his imputed regional/national identity — essentially another case study of the Introduction's "narrating-culture effect" and the Hengist chapter's national-identity material already flagged for caution elsewhere in this file. Not re-derived here as a separate bullet; the four techniques below are the chapter's genuinely new content.)*

- **Reputation as Raw Material Across Retellings (the "Gawain-Effect")** — because Gawain recurs across dozens of independent medieval works, each with wildly different authors and purposes, his established extra-textual fame (courtesy, valor, a habit of love affairs) becomes something individual texts can lean on, play straight, subvert, or use as a source of irony, without needing to re-establish who he is. A romance can open with other characters' assumptions about him (a host's household thrilled to have "the" Gawain under their roof) and then generate its entire tension from whether he fulfills or fails that pre-loaded expectation. Directly applicable to any Doll or Notable Figure who recurs across multiple quests, DLCs, or in-fiction media (song, rumor, a companion's own reputation among factions who've never met her): let other characters' pre-formed assumptions about her established legend do characterization work before she even appears on screen, then choose deliberately whether a given scene fulfills, undercuts, or lets her self-consciously perform that legend.
- **Self-Consciousness of Reputation as the Actual Dramatic Engine** — repeatedly, Gawain's decisions are driven less by principle than by anxiety about how an action will look to his peers if it becomes known — he keeps a shameful secret (the girdle) but refuses an equally private opportunity to flee, purely because discovery of cowardice specifically would be unforgivable to his self-image. The gap between what a character would actually choose in private and what her reputation demands of her in public is itself the source of both comedy (low stakes) and tragedy (high stakes), depending on how far the design pushes it. Useful axis distinct from ordinary internal conflict: build a companion whose choices are legibly driven by "what would people say" rather than conviction, and escalate the stakes of that gap over her questline rather than resolving it early.
- **The Uncle/Nephew Contrast: Competence Without Ambition** — several texts elevate Gawain specifically by making his king, Arthur, look rash, greedy, or prideful by comparison, with Gawain repeatedly cleaning up the consequences of his uncle's bad judgment — yet Gawain never seeks the throne himself; his superiority is pure competence-contrast, not usurpation-adjacent ambition. Distinct from Turnus's Puppet-of-Ambition Dynamic (Ch. 1) and from any "rival to the throne" plot: this is a loyal subordinate who is simply and visibly better at the job than the authority she serves, with that gap doing all the narrative work. Useful for a companion positioned under a flawed City Elder, faction leader, or Notable Figure whose authority the story isn't interested in overthrowing — let her competence embarrass the leader by proximity without ever making the story about a coup.
- **Consistent Inconsistency as Built-In Authorial License** — medieval audiences already understood Gawain's characterization to vary sharply and irreconcilably from text to text, and this expectation itself became a permission structure: individual authors felt free to write sharply different, even contradictory versions of him for different local purposes, without needing to reconcile them into one coherent throughline. Useful franchise-management principle distinct from ordinary characterization: if a recurring figure (a legendary Notable Figure, a companion who appears differently in different DLCs' in-fiction media) is established early as "notoriously variable depending on who's telling the story," that variability itself becomes an accepted feature rather than a continuity problem, freeing future writers to depict her differently in different contexts without needing to justify or unify the versions.

### Gamelyn (Ch. 8, Nancy Mason Bradbury)

This chapter is the collection's first genuine case study of a *protagonist's* violence needing justification rather than an antagonist's sympathy needing calibration — genuinely different terrain from every other Cartlidge chapter mined so far, and correspondingly rich.

- **Weapon-Class as Genre Signal for "This Justice Answers to a Different System"** — the tale systematically strips its hero of knightly weapons and armor and replaces them with blunt, domestic, working-class implements (a kitchen pestle, a cart-shaft, an oak rod used to mock-anoint clerics), which functions as more than practicality: it tells the audience up front not to judge this violence by chivalric rules, and the specific choice of a *cooking* implement against a brother who's just condescended to him as a servant adds a layer of pointed class mockery. Portable device: give a companion or Notable Figure whose violence needs to read as operating outside the game's dominant power structure (not corporate-sanctioned, not military-issue) a weapon or tool visibly drawn from an ordinary trade or domestic life rather than from that structure's own arsenal — the weapon choice itself signals "this justice doesn't answer to your system" before she says a word.
- **Reciprocity, Not Escalation, as Extreme Violence's Moral License** — nearly every act of violence in the tale is staged as an exact, traceable repayment of a specific prior harm (the brother is bound in the very fetters he used, his years of stolen income are spent down to the coin at the banquet he's forced to host) rather than as open-ended vengeance; the poet is careful never to let retribution exceed the scale of the original injury. Distinct from this file's existing antagonist-sympathy tools (this calibrates a *protagonist's own* justified violence, not an antagonist's redeemability): give a companion's acts of retribution exact, legible symmetry with a specific prior wrong — same act, same measure, returned — so that even extreme violence reads as restorative accounting rather than an unleashed temper.
- **Proving the System Is Captured Before Letting the Hero Bypass It** — the tale doesn't let Gamelyn skip legitimate recourse on his own say-so; it first stages, on-screen, a good-faith attempt at legitimate recourse failing through corruption, embodied by a second character (Gamelyn's idealistic, "hende" middle brother Sir Ote, whose honest legal maneuver — standing surety for Gamelyn — nearly gets *him* hanged in Gamelyn's place). Only once this proof-of-capture is visible does the hero's bypass of the law read as forced rather than impatient. This is the structural mirror-image of Turnus's Procedural-Legitimacy Erosion (Ch. 1): there, skipping legitimate channels cost a character her standing precisely because those channels were still real and available; here, demonstrating that the channels are already fully captured is exactly what preserves it. Directly useful pairing for a companion whose "justified" extreme violence needs to survive audience scrutiny: stage one good-faith attempt at legitimate recourse failing through corruption on-screen, ideally suffered by a second character, before letting your protagonist bypass the system herself.
- **The Overturned-Seat Ending: Vigilante Becomes Legitimate Successor to the Same Office** — Gamelyn doesn't just kill the corrupt justice; he ritually announces that he will take the justice's own seat and "dress" (both rearrange and set right) the very judgments it produced, and the crown then formally legitimizes this by appointing him chief justice of the royal forest — converting what began as vigilante violence into a validated succession into the very office that failed. A distinct arc-shape from anything else in this file: a companion's or Notable Figure's violent uprising against a corrupt local authority (a District Elder, a corporate security chief) could culminate not in her defeat or permanent exile but in the setting's own highest legitimate authority retroactively installing her in that same office — "the poacher becomes the gamekeeper" as the actual ending beat, not a punchline.
- **Institutionally-Coded Target Selection as a Political Statement** — the tale's violence is aimed with real precision: the specific office-holders responsible for the injustice (the brother, the bribed justice, the bribed jurors) are killed or maimed; ordinary household retainers are spared and even become silent allies, visibly standing aside to let the hero act; and the clergy are singled out for humiliation rather than lethal violence, reflecting a grievance against an institution's practice rather than a demand for its destruction. Useful precision note for any companion's spree of "justified" violence against a corrupt institution: keep the targeting legible — spare rank-and-file characters complicit only by employment, aim at the specific office-holders responsible, and consider humiliation rather than lethal force against an institution the story needs to critique without erasing (since, unlike a specific corrupt office-holder, the institution itself may need to still exist afterward).

### Ralph the Collier (Ch. 9, Ad Putter)

**Verdict: thin for this supplement's specific purposes.** This chapter is about a low-born charcoal-burner who "earns" knighthood by demonstrating chivalric virtue (generous hospitality, scrupulous promise-keeping) despite rough manners — it is a social-mobility-through-merit story, not a study in irredeemability, sympathetic villainy, or moral ambiguity, and most of its content (accurate hospitality ritual, letter-vs-spirit of promise-keeping, class-crossing merit) belongs, if anywhere, to the *main* character-development methodology file rather than this one, and is not reproduced here. One technique is genuinely adjacent to this supplement's antihero/transgression concerns and worth keeping:

- **Excess-of-Virtue as Transgression** — Ralph's single most surprising trait is that his rudest moments (physically knocking his disguised king to the floor, sharply correcting a guest's manners) aren't failures of courtesy but *over-compliance* with it: he holds the code of hospitality and precedence so much more rigidly than the people around him (including his king) that enforcing it against a superior reads as churlish violence even though it's actually the character behaving *more* correctly than decorum itself demands. Distinct from the Demythologized Sanctity Move already captured from Simmons (where an institution has drifted from a value and a character relocates it) or from ordinary bluntness-as-honesty characterization: this is a character whose transgressive-looking behavior is generated by holding a shared code's own rules *more strictly* than anyone else present, including the very authority figure the code is supposed to protect. Useful for a gruff, blunt, or "difficult" companion who isn't morally ambiguous at all — give her outbursts a traceable root in stricter-than-normal adherence to a value everyone nominally shares, so her rudeness reads as principle taken further than anyone else was willing to take it, not as looser ethics.

### Crusaders (Ch. 11, Robert Allen Rouse)

*(This chapter's entire subject is the real-world Crusades and English/French/"Saracen" religious-national conflict — about as real-world-specific and religiously loaded as source material gets. The three techniques below are stripped down to pure structural mechanism, with all specific religious, national, and ethnic content left out; do not restore any of that content when applying them.)*

- **Legitimacy-by-Bounded-Scope, Not by Method** — one romance discussed here draws its line between righteous and illegitimate violence not at the fact of violence, or even at who commits it, but purely at geographic/purpose scope: defending a specific, already-held place is legitimate; pursuing the same enemy into unclaimed territory for conquest is condemned as "great folly," with identical fighters and identical tactics on both sides of the line. Useful, reusable in-fiction axis distinct from anything already in this file: let a companion's or faction's violence be judged legitimate in a defensive campaign and condemned in an offensive one that follows immediately after, with no change to her personal conduct — the story's judgment tracks scope-creep, not the violence itself, which gives a clean lever for a "companion goes too far" beat that doesn't require her methods to change at all, only her aim.
- **Motivation-Audit as Its Own Redemption Trigger** — one hero's turning point comes not from an external event, a confrontation, or an origin-reveal, but from a private, solitary act of retrospective self-audit: reviewing his own celebrated, skillfully-executed, universally-honored career and privately concluding it was undertaken the whole time for the wrong internal reason (reputation and gain, not genuine conviction) — nothing he did is re-litigated, only why he did it. Distinct from the Origin-Reveal Catalyst and "Scale, Not Kind" material already captured from Sons of Devils (Ch. 14, which turns on learning who a character *is*): this turns on a character auditing who she's *been doing it for*, with no new information arriving from outside her — a workable arc for a companion whose reckoning isn't "I did something wrong" but "I did the right things for the wrong reasons the entire time," redirecting her rather than shaming her.
- **Externally-Imposed Abjection as a Redemption Gate, Distinct from Its Trigger** — the chapter's discussion of Sir Gowther (already partly mined via the Sons of Devils chapter for its origin-reveal catalyst) adds a structurally separate detail worth keeping: after learning his monstrous parentage, Gowther's path back isn't private guilt or a quiet change of direction, but a publicly humiliating, externally imposed, and strictly wordless penance (eating only what he can take from dogs' mouths, forbidden to speak) that must run to completion, witnessed, before any subsequent heroic act is allowed to count toward redemption. This is a harsher and more ritualized gate than the trigger itself: full sensory and social abjection as a *prerequisite phase*, not a backdrop, to the redemptive act that follows. Useful for a companion whose atrocities are severe enough that the story wants a distinct, visible, temporary period of degradation completed and witnessed by others before her actions can begin to read as redemptive rather than merely convenient — the abjection has to finish on-screen for the later heroism to land as earned.
- **Flagged as an anti-pattern, not a technique: Legitimacy-by-Victim-Designation Alone** — the chapter also documents the crude, purely victim-status-based justification medieval crusade material sometimes falls back on (violence is righteous simply because the target is pre-designated as the enemy of the faith, independent of the act's actual brutality or proportion — the source material's own anecdote of a knight clubbing a religious opponent unconscious and being narratively vindicated purely because of who the victim was). Worth naming explicitly as the lower bar this file's other techniques exist to clear, not one to reach for: don't let a companion's or faction's violence be "laundered" as righteous solely by asserting the target belonged to an already-designated enemy category. Turnus's "When Mercy Must Be Refused" checklist (Ch. 1) — has the narrative actually closed every legitimate avenue of sympathy first? — is the higher bar to hold instead.

### Saracens (Ch. 12, Siobhain Bly Calkin)

*(Like the Crusaders chapter, this one is built entirely from real-world Christian/Muslim conflict in medieval literature. This is also the chapter that supplies the full case study behind the Introduction's already-captured "noble-enemy challenge" category (an opposing faction's members embody the home faction's own values more fully, becoming an implicit indictment simply by existing) — the summary line is already in this file; what follows is the specific machinery behind it, abstracted well clear of any religious or ethnic specifics, that the one-line summary doesn't capture.)*

- **The Convert-as-Insider-Critic** — a formerly-outside character who has genuinely joined the "home" faction retains standing to criticize that faction's own flaws (competitiveness, recklessness, weak discipline) in a way that lands as legitimate rather than as enemy propaganda, precisely because the text has already validated her as now belonging. Distinct from the Noble-Enemy pattern (where the critic stays outside): here the critique is delivered by someone the story has already certified as "one of us," which is exactly what keeps the criticism from being dismissed as bias. Reusable device for delivering real criticism of a faction's own culture (a city council's complacency, a mercenary company's overconfidence) without it reading as hostile propaganda: voice it through a companion who has genuinely and recently joined that faction from outside — her insider status is what makes the critique impossible to wave away.
- **Same Conflict, Two Complete and Incompatible Framings, Staged as a Live Argument** — in one confrontation, both combatants describe the identical duel in fully coherent but totally different terms (one insists it is purely a contest of faith; the other insists it is a personal act of treason against kin and lord), and the text is explicit that both framings are simultaneously valid on their own terms, declining to adjudicate between them even as the plot itself resolves in one side's favor. A more theatrical cousin of Alexander's Split Judgement and the Full-Weight Two-Horned Dilemma (Ch. 2): instead of a narrator holding two verdicts at once, stage the two readings as dialogue between the two people who each have the most at stake in their own version being the true one, and let the scene end without the narration ever picking a winner, independent of who wins the fight.
- **Contrastive Domestic Virtue Through Supporting-Cast Juxtaposition, Not Accusation** — Guy of Warwick surrounds its hero's pilgrimage with three antagonist-coded father figures, each vividly and specifically devoted to his own son's welfare, in the very same stretch of story where the hero himself never once mentions or thinks about the infant son he has just left behind. No character ever accuses the hero of neglect; the critique exists purely in the juxtaposition. Useful for critiquing a companion's or Notable Figure's personal-life failing (as a parent, partner, or friend) without staging a single confrontation scene about it: populate the surrounding cast for that stretch of story, including antagonists, with characters who quietly and specifically model the domestic virtue she's failing at, and let the contrast do the work unaccompanied by any character's direct accusation.
- **Witnessing-Reaction as an Unstated Verdict** — in one notorious episode, one in-fiction audience watching an atrocity laughs and treats it as a boastful joke, while a second in-fiction audience watching the very same act is horrified, revolted, and unable to eat; the narration never states which reaction is correct, but stages the second audience's specific grief (they name the dead, describe their families) immediately alongside the first audience's laughter, tilting the reader toward the darker reading through pure contrast of response rather than commentary. Distinct from Merlin's unglossed reactions (Ch. 6, which leaves a single character's response ambiguous): this pairs two different in-fiction audiences' opposite reactions to the same act side by side, letting the gap between them do the moral work. Useful for a scene where the player-facing narrative wants to destabilize an otherwise-celebrated character's "triumphant" act without any character directly condemning it: show two different groups of witnesses reacting to it in incompatible ways, and let the more humanizing reaction land last.
- **Humanizing the Body Count at One Deliberate Moment, Not Routinely** — the routine, unremarked killing of nameless enemy combatants that runs through an entire genre suddenly registers as a real cost the instant a handful of the dead are given names, grieving relatives, and specific words of loss ("our children," "our heirs") — a device the text uses exactly once, at exactly the moment it wants the audience to feel what a kill count actually costs, without retroactively condemning any of the routine, undescribed killing that surrounds it. Calibratable technique distinct from ongoing "grimdark" tone-setting: reserve this for one specific, chosen scene where a companion's or the player's own battlefield toll needs to land emotionally, give a small number of the otherwise-anonymous dead names and named mourners for that scene only, and let the rest of the game's combat remain at its normal register — overusing the device flattens it into background noise rather than a deliberate gut-punch.

### Ungallant Knights (Ch. 13, James Wade) — remainder of the chapter

*(Only the concluding argument of this chapter was read in the earlier pass, which is where "The Consequence-Presence Dial" above came from — the contrast between a victim's suffering being given real narrative weight versus being narratively skipped over. Having now read the rest of the chapter, that bullet stands as written; the two findings below are new, drawn from the chapter's actual argument about manuscript context and reading practice, which the concluding-argument-only read hadn't reached.)*

- **Proximate-Text Calibration: the Same Transgression Reads Differently Depending on What Surrounds It** — the chapter's central methodological claim, built from real manuscript evidence: fifteenth-century household miscellanies mixed romances with sermon exempla, cautionary tales, and moralizing lyrics, and audiences habituated to "read for the moral" by the surrounding didactic material carried that habit into whatever romance came next — so the exact same hero's exact same morally ambiguous behavior (a knight's careless treatment of the women he sleeps with) reads as harmless genre-convention escapism in isolation, but as a real character indictment when it sits next to texts that have just spent several pages detailing the consequences of sexual sin in vivid, punitive detail. Nothing in the transgressive scene itself needs to change for its moral weight to shift completely. Directly portable to this project's own quest sequencing: a companion's morally ambiguous action can be calibrated toward a "serious" or "escapist/comic" reading purely by what quest or scene the player experiences immediately before or after it, independent of how the scene itself is written — placing a companion's callous choice right after a quest that dwelt on the real cost of a similar callousness will read as damning; placing the identical scene after a lighthearted heist quest will read as roguish charm. Distinct from "The Consequence-Presence Dial" above (which is about whether the *scene itself* gives the victim narrative weight): this lever is entirely external to the scene, governed by sequencing and adjacency in the player's actual playthrough.
- **The Convenient-Forgetting Pattern, Revealed Retrospectively by a Mirror** — one hero's story is structured so that he sequentially abandons two women he's wronged, each time simply riding off to the next adventure while the narrative itself participates in the forgetting, never mentioning either woman again — until, at the very end, his own father is revealed to have done the identical thing to the hero's mother, retroactively recasting what looked like a string of small, individually forgivable incidents as an inherited pattern. Distinct from Turnus's Implicit Contrast via Selective Omission (Ch. 1, which uses omission to make a virtue's absence conspicuous): here the omission hides a *vice* in plain sight, and it's a late structural mirror — not authorial comment — that finally makes the pattern visible. Useful for a companion whose real flaw is a repeated small behavior the narrative deliberately underplays each time it happens, with a late-game parallel (a mirrored figure, a repeated scene shape) doing the work of making the player recognize, all at once, a pattern they'd been quietly shown all along without being told to notice it.

*(Cartlidge disposition: now read in full — the Introduction, all fourteen chapters, and the Conclusion/Index boundary. Confirms, per Cartlidge's own Introduction, that "anti-hero" has no native medieval equivalent — this is a modern analytical lens applied backward to a genre that never used the term itself, which was the developer's own suspicion going in. Ralph the Collier (Ch. 9) was read but judged thin for this supplement's specific purposes and only partially mined; the other nine newly-read chapters (Turnus, Alexander the Great, Hengist, Harold Godwineson, Merlin, Gawain, Gamelyn, Crusaders, Saracens) plus the remainder of Ungallant Knights all yielded genuine design material, mined above. Disposition of the whole book not yet decided by the developer.)*
