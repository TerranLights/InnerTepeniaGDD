...
### Possible Hooks
- **The Audit Goes Forward:** Help her surface the Capricorn Capricorn's core injustice [mechanism TBD — 4 contenders shortlisted, see `06b_Capricorn_Alternative_Conditions.md`] findings in a way that protects her people from immediate retaliation — she needs a distribution strategy, not just the document. Once the information can travel without her, she can move.
...
- **Prove the Trade Is Worth It:** Demonstrate that what you are doing matters as much to robot dignity as what she is already fighting for. She will not trade her cause for yours unless yours earns it.
...
Not the statistics of the Capricorn's core injustice [mechanism TBD — 4 contenders shortlisted, see `06b_Capricorn_Alternative_Conditions.md`] — the individual people. The robots who worked harder and were moved to lower housing and told they had not earned better, and accepted it because the system said so.
...
### Possible Endings
- **Public:** The Capricorn's core injustice [mechanism TBD — 4 contenders shortlisted, see `06b_Capricorn_Alternative_Conditions.md`] becomes fully public — the rating system is formally challenged. Major Capricorn political arc.
...
- The Capricorn's core injustice [mechanism TBD — 4 contenders shortlisted, see `06b_Capricorn_Alternative_Conditions.md`] of 2761 is the primary exhibit. Finding and deploying it is likely a central act in the quest.
