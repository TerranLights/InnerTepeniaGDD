...
- **Tepenian city before Concordia (updated 2026-07-03, still not decided):** Esperanza was floated first but dropped — no Japan presence at any composition tier. Leading candidates are **Denison** (`Cities/Local_Cultures/Janbogo_Subnet/Denison.md`, destroyed) or **Casey** (`Cities/Local_Cultures/Mirny_Subnet/Casey.md`) — both now fully written, both have Japan at Significant tier (Casey's leads T2), so either is a demographically consistent fit. Zhongshan and Janbogo also still qualify if neither fits narratively. **Mawson** (`Cities/Local_Cultures/Mawson_Subnet/Mawson.md`) is a candidate as of 2026-07-03 — also has Japan at Significant tier, and its own hook ("The Name That Outlasted the Founders," a genuinely China/Japan/Korea/Indonesia-facing demographic city) could add an interesting textural note: Ayako relocating from a subnet hub city with real institutional depth and continuity, rather than a smaller or destroyed one. **Shirayuki** *(named 2026-07-08; formerly tracked as "Japanese Diplomatic Partition, cf. Bharati")* is a structurally obvious late addition, flagged same day — its founding population is Japanese by design (an Upper Earth diplomatic allocation via the Jeju-do court), though its full cultural sheet isn't written yet, only its founding story and status. All other spec sheets are ready — decision itself is still open, revisit whenever.
