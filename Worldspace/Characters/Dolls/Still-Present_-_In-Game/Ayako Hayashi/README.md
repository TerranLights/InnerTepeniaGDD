...
- **Tepenian city before Concordia (updated 2026-07-03, still not decided):** Esperanza was floated first but dropped — no Japan presence at any composition tier. Leading candidates are **Denison** (`Cities/Local_Cultures/Janbogo_Subnet/Denison.md`, destroyed) or **Casey** (`Cities/Local_Cultures/Mirny_Subnet/Casey.md`) — both now fully written, both have Japan at Significant tier (Casey's leads T2), so either is a demographically consistent fit. Zhongshan and Janbogo also still qualify if neither fits narratively. Both spec sheets are ready — decision itself is still open, revisit whenever.
